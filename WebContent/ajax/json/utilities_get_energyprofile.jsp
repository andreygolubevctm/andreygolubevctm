...
<c:set var="searchId"><c:out value="${param.searchId}" escapeXml="true"/></c:set>

<c:set var="energyProfile">
	<go:scrape url="${sw_url}/EnergyProfile/${searchId}" sourceEncoding="UTF-8" username="${sw_user}" password="${sw_pwd}" />
</c:set>
