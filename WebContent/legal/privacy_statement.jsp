...
<c:choose>
	<c:when test="${pageSettings.getVerticalCode() == 'homeloan'}">
		...
		<p>
			The information we collect depends on what products and quotes you are comparing and without this information, we wouldn't be able to offer our service. Information about persons named must be given with their consent. We use your information, some of which may be sensitive, to provide you with quotes and/or comparisons. If you choose a product, we'll pass this information on to the chosen product provider or their broker who may contact you. We may also use it to keep you up-to-date with our services and products. We may also pass on your information to Australian Finance Group Ltd ACN 066 385 822 (AFG) to enable an AFG broker to contact you to discuss your finance needs.
		</p>
		<p>
