...
<c:choose>
	...
	<c:when test="${pageSettings.getBrandCode() == 'cc'}">

		<p>
			The information we (and our related companies) collect depends on what products and quotes you are comparing and without this information, we wouldn't be able to offer our service. Information about persons named must be given with their consent. We use your information, some of which may be sensitive, to provide you with quotes and/or comparisons. If you choose to apply for a product, we'll pass this information on to the chosen product provider. We may also use it to keep you up-to-date with our services and products.
		</p>
		<p>
			Your personal information (but not your sensitive information) may be held by some of our service providers in an overseas location, the details of which can be found in our privacy policy. In this privacy policy, you can also find out more about the information we (and our related companies) hold and how to correct it, as well as how to make a complaint and how this complaint will be handled. &nbsp;&nbsp;<a href="${pageSettings.getSetting('privacyPolicyUrl')}" target="_blank">View Privacy Policy</a>
		</p>
