...
<c:choose>
							...
							<ul>
								<c:forEach items="${brands}" var="brand">
									...
									<li style="padding:5px 0px;">
										<a style="text-decoration:underline" class="needs-loadsafe" href="${baseUrl}simples/redirectToBrand.jsp?brandId=${brand.getId()}&verticalCode=${verticalCode}">
	...
	<c:when test="${brands.size() == 1}">
		...
		<c:redirect url="${baseUrl}simples/redirectToBrand.jsp?brandId=${brand.getId()}&verticalCode=${verticalCode}"/>
