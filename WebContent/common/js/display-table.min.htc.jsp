<%@ page contentType="text/x-component;charset=UTF-8" %><!DOCTYPE html><public:component lightweight="true"><public:attach event="ondocumentready" onevent="_(element)" /><script>
/**
...
<%--
	*********************************************************************
	FUE-18: This file was changed to a JSP and the Content type set at
	the top because Tomcat wouldn't give it the correct content type and
	wouldn't execute the script - this rough-housing solved the issue :D
	*********************************************************************
--%>