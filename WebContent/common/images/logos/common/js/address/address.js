...
function init_address(name){
	...
	postCodeFld.change(function(e){
		...
		if (nonStdFld.checked) {
			...
			// Postcode less than 4 chars in length
			} else {
	...
	var searches = [
				...
				{"name":"Level_UnitNo/Number_Street",
					"regex":"^[Ll][Ee][Vv][Ee][Ll][\\s+]?([a-zA-Z]*)(\\d*)([a-zA-Z]*)[/\\s]+([\\d-]+[a-zA-Z]*)\\s+([\\w\\W\\s]+)$",
					"fields":["prefix","level","suffix","houseNo","street"]},
					
				{"name":"Lvl_UnitNo/Number_Street",
					"regex":"^[Ll][Vv]?[Ll]?[\\s+]?([a-zA-Z]*)(\\d*)([a-zA-Z]*)[/\\s]+([\\d-]+[a-zA-Z]*)\\s+([\\w\\W\\s]+)$",
					"fields":["prefix","level","suffix","houseNo","street"]},

				{"name":"UNITNO_UnitNo/Number_Street",
						"regex":"^[Uu][Nn][Ii][Tt]\\s*[Nn][Oo][\.]*\\s*([a-zA-Z]*)(\\d*)([a-zA-Z]*)[/\\s]+([\\d-]+[a-zA-Z]*)\\s+([\\w\\W\\s]+)$",
						"fields":["prefix","unit","suffix","houseNo","street"]},
																			
				{"name":"UNIT_UnitNo/Number_Street",
					"regex":"^[Uu][Nn][Ii][Tt]\\s*([a-zA-Z]*)(\\d*)([a-zA-Z]*)[/\\s]+([\\d-]+[a-zA-Z]*)\\s+([\\w\\W\\s]+)$",
					"fields":["prefix","unit","suffix","houseNo","street"]},

        		{"name":"UnitNo_Number_Street", 
					"regex":"^([a-zA-Z]*)(\\d*)([a-zA-Z]*)/([\\d-]+[a-zA-Z]*)\\s+([\\w\\W\\s]+)$",
					"fields":["prefix","unit","suffix","houseNo","street"]},
					
				{"name":"UnitNo/Number_Street", 
					"regex":"^([a-zA-Z]*)(\\d*)([a-zA-Z]*)[/\\s]+([\\d-]+[a-zA-Z]*)\\s+([\\w\\W\\s]+)$",
					"fields":["prefix","unit","suffix","houseNo","street"]},
				...
				{"name":"U_UnitNo/Number_Street",
					"regex":"^[Uu]\\s*([a-zA-Z]*)(\\d*)([a-zA-Z]*)[/\\s]+([\\d-]+[a-zA-Z]*)\\s+([\\w\\W\\s]+)$",
					"fields":["prefix","unit","suffix","houseNo","street"]},
	...
	streetFld.reset=function(){
		// reset is address previously set
