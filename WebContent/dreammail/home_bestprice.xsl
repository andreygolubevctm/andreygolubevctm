...
<xsl:stylesheet version="1.0"
	...
	<!-- SET THE VARIABLES ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
		...
		<xsl:variable name="address">
			<xsl:choose>
				<xsl:when test="home/property/address/nonStd = 'Y'">
					<xsl:choose>
						<xsl:when test="home/property/address/unitShop">
							<xsl:value-of select="home/property/address/unitShop" />/
						</xsl:when>
					</xsl:choose>
					<xsl:value-of select="home/property/address/streetNum" /> <xsl:value-of select="home/property/address/nonStdStreet" />, <xsl:value-of select="home/property/address/suburb" />, <xsl:value-of select="home/property/address/postCode" />
				</xsl:when>
				<xsl:otherwise>
					<xsl:value-of select="home/property/address/streetSearch" />, <xsl:value-of select="home/property/address/postCode" />
				</xsl:otherwise>				
			</xsl:choose>
		</xsl:variable>
