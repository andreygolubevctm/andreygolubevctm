...
<c:import var="init_config" url="/WEB-INF/aggregator/car/Hollard/config_REIN_init.xml" />
...
<c:choose>
	...
	<c:when test="${empty token}">
		...
		<c:import var="inbound_xsl" url="/WEB-INF/aggregator/car/Hollard/v1/REIN_inbound.xsl" />
		<c:set var="tokenResultXml">
			<x:transform doc="${tokenResultXml}" xslt="${inbound_xsl}" xsltSystemId="/WEB-INF/aggregator/car/Hollard/v1/REIN_inbound.xsl" />
		</c:set>
