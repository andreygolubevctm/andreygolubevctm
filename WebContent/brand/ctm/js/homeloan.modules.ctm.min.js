...
})}}function g(){m.modules.loadingAnimation.hide(j),k!==!1&&k.show()}function h(){j.addClass("hidden")}function i(){j.removeClass("hidden")}{var j,k,l,m=window.meerkat,n=m.modules.events;m.logging.info}m.modules.register("homeloanResultsLoadMore",{init:b,onStart:d,onComplete:g,hide:h,show:i})}(jQuery),function(a){function b(){f=a(".snapshotGoal"),g=a(".product-snapshot"),a("#homeloan_enquiry_contact_firstName, #homeloan_enquiry_contact_lastName").on("change",d)}function c(){d(),e()}function d(){var b='<p>Looking to <span data-source="#homeloan_details_goal"></span>';"E"===a("#homeloan_details_situation").val()&&(b+=a("#homeloan_details_currentLoan_Y").is(":checked")?" with an existing loan":" with no existing loan",b+=' and property worth <span data-source="#homeloan_details_assetAmountentry"></span>'),b+='. Looking to borrow <span data-source="#homeloan_loanDetails_loanAmountentry"></span>.',f.html(b),h.modules.contentPopulation.render(".journeyEngineSlide:eq(2) .snapshot")}function e(){var b=Results.getSelectedProduct();if(b!==!1){var c=a("#snapshot-template").html(),d=_.template(c),e=d(b);g.html(e)}else g.empty()}{var f,g,h=window.meerkat,i=(h.modules.events,h.logging.info,{homeloanSnapshot:{}});i.example}h.modules.register("homeloanSnapshot",{initHomeloanSnapshot:b,events:i,renderSnapshot:d,onEnter:c})}(jQuery),function(a){function b(){a(document.body).on("click",".btn-view-brands",e),i.on("change",function(){a(this).is(":checked")?(f.attr("required","required").valid(),g.attr("required","required").valid(),h.attr("required","required").valid()):(f.removeAttr("required").valid(),g.removeAttr("required").valid(),h.removeAttr("required").valid())}),j.on("change",function(){var a=[],b=k.val();k.val(""),"E"===j.val()?(a=[{code:"APL",label:"Buy another property to live in"},{code:"IP",label:"Buy an investment property"},{code:"REP",label:"Renovate my existing property"},{code:"CD",label:"Consolidate my debt"},{code:"CL",label:"Compare better home loan options"}],c(s,!0)):(a=[{code:"FH",label:"Buy my first home"},{code:"IP",label:"Buy an investment property"}],c(s,!1),p.val(""),q.val(""),$propertyWorth.val(""),$propertyWorthHidden.val(""));for(var d=[],e='<option id="homeloan_details_goal_" value="">Please choose...</option>',f=0;f<a.length;f++)e+='<option id="homeloan_details_goal_'+a[f].code+'" value="'+a[f].code+'">'+a[f].label+"</option>",d.push(a[f].code);k.html(e),b&&-1!=d.indexOf(b)&&k.val(b).change()}),""!==j.val()&&j.change(),k.on("change",function(){var b=a(this).val(),d=a("#homeloan_details_currentLoan_Y").is(":checked");"CD"==b||"CL"==b?(p.val(""),q.val(""),c(r,!1),c(t,!1),m.val(""),n.val("")):"FH"===b||"APL"===b||"IP"===b?(d&&c(r,!0),c(t,!0)):(d&&c(r,!0),c(t,!1),m.val(""),n.val(""))}),l.on("change",function(){a("#homeloan_details_currentLoan_Y").is(":checked")&&"CD"!=k.val()&&"CL"!=k.val()?c(r,!0):c(r,!1),p.val(""),q.val("")}),m.on("blur.hmlValidate",function(){0!==o.val().length&&_.delay(function(){o.isValid(!0)},250)})}function c(a,b){b?a.addClass("show_Y").removeClass("show_N show_"):a.addClass("show_N").removeClass("show_Y show_")}function d(){a(document).ready(function(){f=a("#homeloan_contact_firstName"),g=a("#homeloan_contact_lastName"),h=a("#homeloan_contact_email"),i=a("#homeloan_contact_optIn"),j=a("#homeloan_details_situation"),k=a("#homeloan_details_goal"),l=a('input:radio[name="homeloan_details_currentLoan"]'),m=a("#homeloan_loanDetails_purchasePriceentry"),n=a("#homeloan_loanDetails_purchasePrice"),o=a("#homeloan_loanDetails_loanAmountentry"),p=a("#homeloan_details_amountOwingentry"),q=a("#homeloan_details_amountOwing"),$propertyWorth=a("#homeloan_details_assetAmountentry"),$propertyWorthHidden=a("#homeloan_details_assetAmount"),r=a("#homeloan_details_currentLoanToggleArea"),s=a(".homeloan_details_existingToggleArea"),t=a(".homeloan_loanDetails_purchasePriceToggleArea"),f.removeAttr("required"),g.removeAttr("required"),h.removeAttr("required"),b()})}function e(){var b=_.template(a("#brands-template").html()),c={};c.pretext="<h2>Our Home Loan Lender Panel</h2><p>We can help you find a loan to suit your needs. With access to over 1,300 home loan products from 29 of Australia's reputable lenders, finding a tailored loan to suit your needs has never been so easy.</p>";{var d=b(c);u.modules.dialogs.show({title:a(this).attr("title"),htmlContent:d,hashId:"brands",closeOnHashChange:!0,openOnHashChange:!1})}return!1}{var f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u=window.meerkat;u.modules.events,u.logging.info}u.modules.register("homeloanStart",{init:d})}(jQuery);
