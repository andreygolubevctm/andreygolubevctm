								...
								<Value>
									<xsl:choose>
    									<xsl:when test="$env = '_PRO'">
    										<![CDATA[https://secure.comparethemarket.com.au/ctm/retrieve_quotes.jsp]]>
    									</xsl:when>
    									<xsl:otherwise><![CDATA[https://qa.secure.comparethemarket.com.au/ctm/retrieve_quotes.jsp]]></xsl:otherwise>
									</xsl:choose>
    							</Value>
							</Variable>
							<Variable>
