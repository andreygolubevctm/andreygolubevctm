...
<%-- HIDDEN FIELDS --%>
<field:hidden xpath="${mailCheckDataFieldXPath}" defaultValue="${mailCheckData}" />
<field:hidden xpath="${attemptsFieldXPath}" defaultValue="" />
<field:hidden xpath="${selectionsFieldXPath}" defaultValue="" />
