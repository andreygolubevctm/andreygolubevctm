...
<%-- HTML --%>
<field_new:autocomplete xpath="${xpath}" className="blur-on-select show-loading" title="Postcode/Suburb" required="${required}" source="ajax/json/get_suburbs.jsp?fields=postcode%2C+suburb%2C+state&term="  placeholder="${placeholder}"/>
