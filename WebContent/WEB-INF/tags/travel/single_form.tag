...
<fmt:setLocale value="en_GB" scope="session" />
	...
	<form:fieldset legend="Dates &amp; Travellers" className="narrower">
		...
		<div class="twocol">
			<field:date_range minDate="today" maxDate="${maxDate}" prefill="true" showIcon="true" helpIdFrom="214" helpIdTo="215" helpClassName="fright" xpath="travel/dates" className="dates_label" inputClassName="basicDate narrow_input" labelFrom="When do you leave?" labelTo="When do you return?" titleFrom="departure" titleTo="return" required="true" allowDateReset="true"></field:date_range>
			<div class="clear"></div>
		</div>
