		...
		<div class="panels">
			<div class="panel-row">
				...
				<div class="panel" id="health-insurance-box">
					<div class="box">
						<a class="button compare-button buybtnbig alt" href="http://www.comparethemarket.com.au/health-insurance/"><span>Health Insurance</span></a>
					</div>
				</div>
			
				<div class="panel" id="car-insurance-box">
					<div class="box">
						<a class="button compare-button buybtnbig alt" href="<core:get_setting brand="ctm" application="car" setting="exit-url" />"><span>Car Insurance</span></a>
					</div>
				</div>
				
				<div class="panel" id="life-insurance-box">
					<div class="box">
						<a class="button compare-button buybtnbig alt" href="http://www.comparethemarket.com.au/life-insurance/"><span>Life Insurance</span></a>
					</div>
				</div>
				 
				<div class="panel" id="travel-insurance-box">
					<div class="box">
						<a class="button compare-button buybtnbig alt" href="<core:get_setting brand="ctm" application="travel" setting="exit-url" />"><span>Travel Insurance</span></a>
					</div>
				</div>
				
				<div class="panel" id="income-protection-box">
					<div class="box">
						<a class="button compare-button buybtnbig alt" href="http://www.comparethemarket.com.au/income-protection/"><span>Income Protection</span></a>
					</div>
				</div>
								
				<div class="panel" id="roadside-box">
					<div class="box">
						<a class="button compare-button  buybtnbig alt" href="<core:get_setting brand="ctm" application="roadside" setting="exit-url" />"><span>Roadside Assistance</span></a>
					</div>
				</div>
				
				<div class="panel" id="ctp-box">
					<div class="box">
						<a class="button compare-button  buybtnbig alt" href="http://www.comparethemarket.com.au/ctp-insurance/"><span>CTP</span></a>
					</div>
				</div>
				
				<div class="panel" id="fuel-prices-box">
					<div class="box">
						<a class="button compare-button  buybtnbig alt" href="<core:get_setting brand="ctm" application="fuel" setting="exit-url" />"><span>Fuel Prices</span></a>
					</div>
				</div>
