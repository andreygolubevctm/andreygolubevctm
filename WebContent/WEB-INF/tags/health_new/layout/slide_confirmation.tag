...
<c:set var="confirmationData"><health_new:load_confirmation /></c:set>
...
<%-- TEMPLATES --%>
	...
	<health_new:logo_price_template />
	...
	<script id="confirmation-template" type="text/html">
		...
		<layout:slide_columns>
			...
			<jsp:attribute name="rightColumn">
				...
				<div class="hidden-xs">
					<health_new:policySummary showProductDetails="true" />
				</div>
					...
					<div class="col-xs-12">
						...
						<div class="brochureLinks">
							{{ if(promo.hospitalPDF) { }}
								<p>
									<a href="/${pageSettings.brand}/{{= promo.hospitalPDF }}" target="_blank" class="btn btn-hospital-light">Download Hospital Brochure</a>
								</p>
							{{ } }}

							{{ if(promo.extrasPDF) { }}
								<p>
									<a href="/${pageSettings.brand}/{{= promo.extrasPDF }}" target="_blank" class="btn btn-extras-light">Download Extras Brochure</a>
								</p>
							{{ } }}
						</div>
					</div>
			...
			<jsp:body>
				...
				<layout:slide_content >
					...
					<ui:bubble variant="info" className="moreInfoBubble">
						...
						<p>You've compared the market and found the right <strong>Health Cover</strong> for you. We hope you've enjoyed comparing with us.</p>
					</ui:bubble>
						...
						{{ if(typeof hospitalCover !== 'undefined') { }}
							...
							<div class="col-xs-6">
								...
								{{ if(hospitalCover.restrictions.length > 0) { }}
									...
									<span class="text-italic small">See policy brochure for more details</span>
								{{ } }}
