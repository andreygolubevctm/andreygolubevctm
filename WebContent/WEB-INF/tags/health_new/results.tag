...
<agg_new_results:results vertical="${pageSettings.vertical}">
	...
	<div class="resultsMarketingMessage" >
			<div class="insert">
				...
				<p>
					<strong>Health Insurance</strong> can be complicated. If you need a hand, here's why you should call us.
				</p>
				...
				<div class="resultInsert">
					<div class="compareBar">
						...
						<div class="comparisonInactive">
							<strong>click</strong> the <div class="compareCheckbox compareCloseIcon"><input type="checkbox" class="compare compareCloseIcon" checked disabled /><label ></label></div> to <strong>add</strong> to your <strong>shortlist</strong> and <em>compare</em> from <span class="productCount"></span> <span class="smaller">matching your needs.</span>
						</div>
