...
<c:set var="callCenterStatus" scope="request" value="${openingHoursService.getCurrentStatusOfCallCenter(pageContext.getRequest())}"  ></c:set>
<c:set var="callCentreNumber" scope="request"><content:get key="callCentreNumber"/></c:set>


<div class="opening-hours">
								  <%-- <span>${callCenterStatus}</span> 
								// if customer complaints about time status uncomment this line,it displays current status 'open' or 'closed'--%>
