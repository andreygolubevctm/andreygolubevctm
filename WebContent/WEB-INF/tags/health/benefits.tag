	...
	<form class="benefits-component">
		...
		<div class="scrollable row">
			...
			<div class="hidden-xs col-sm-12">
				...
				<p>The benefits you choose will help determine the price of the policies you are comparing. You can choose from <strong>Hospital</strong>, <strong>Extras</strong> or both by clicking the YES/NO buttons for each, and then selecting your benefits.
