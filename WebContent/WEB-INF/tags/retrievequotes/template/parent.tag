...
<core:js_template id="action-button-template">
    ...
    {{ if(verticalData.pendingID && verticalData.pendingID.length) { }}
        <a href="javascript:;" data-vertical="{{= obj.verticalCode }}" data-transactionId="{{= obj.transactionId }}" data-pendingid="{{= verticalData.pendingID }}" class="btn btn-sm btn-block btn-tertiary btn-pending"><span>In Processing</span></a>
    {{ } else { }}
        {{ if(verticalData.inPast) { }}
            <a href="javascript:;" data-vertical="{{= obj.verticalCode }}" data-transactionId="{{= obj.transactionId }}" data-inpast="{{= verticalData.inPast }}" class="btn btn-sm btn-block btn-secondary btn-latest"><span>Get Latest Results</span></a>
        {{ } }}

        <a href="javascript:;" data-vertical="{{= obj.verticalCode }}" data-transactionId="{{= obj.transactionId }}" class="btn btn-sm btn-block btn-tertiary btn-amend"><span>Amend Quote</span></a>
        ...
        {{ if(obj.verticalCode === "health") { }}
            <a href="javascript:;" data-vertical="{{= obj.verticalCode }}" data-transactionId="{{= obj.transactionId }}" class="btn btn-sm btn-block btn-tertiary btn-start-again"><span>Start Again</span></a>
        {{ } }}
    {{ } }}
</core:js_template>
