...
<form:fieldset legend="More details about the Regular Driver">
	...
	<form:row label="Employment status">
		<field:import_select xpath="quote/drivers/regular/employmentStatus"
			required="true" className="employment_status" helpId="27"
...
<form:fieldset legend="Now we need some info about the youngest driver of the car">
	<group:youngDriver_selection xpath="quote/drivers/young" />

	<form:row label="You may be able to reduce the premium if you restrict the age of the drivers" id="quote_restricted_ageRow">
