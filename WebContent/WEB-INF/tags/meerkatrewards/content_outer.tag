...
<div class="row">
	...
	<a href="http://www.comparethemeerkat.com.au"><div class="meerkatLogo"><img src="brand/ctm/competition/meerkat_rewards/img/meerkatLogo.png" /></div></a>
		...
		<!-- Header Content -->
				...
				<div class="heroImage">
							<img src="brand/ctm/competition/meerkat_rewards/img/heroImage.png" class="widthOneHundred"><br>
				</div>
					</div>

			<div class="large-5 columns crest"></div>

					<div class="large-5 columns">
									<div class="panel panelForm">
							<h5 class="gold">Enter my one question quiz here. Simples!<hr class="goldHrTwo"></h5>
								<p class="gold"><strong>QUESTION 1. AHEM.</strong><br>
						To find good insurance deal I would go to...
					</p>
