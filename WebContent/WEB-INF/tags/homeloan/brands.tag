...
<core:js_template id="brands-template">
	...
	<c:set var="brands"
		value="${fn:split('ADLB,AFG,AMP,ANZ,BOM,BANKSA,BANKWEST,BLUESTONE,BOQ,CBA,CITI,HERITAGE,HOMESTART,ING,KEY,LATROBE,LIBERTY,MACQ,ME,MKM,NAB,NABBROKER,PN,PEPPER,GEORGE,SUNCORP,ROCK,WESTPAC,AUSWIDE',',')}" />
