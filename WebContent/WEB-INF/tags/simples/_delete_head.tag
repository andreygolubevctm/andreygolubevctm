...
<%-- STYLESHEETS --%>
	...
	<link rel='stylesheet' type='text/css' href="${go:AddTimestampToHref('brand/ctm/simples.css')}" />
	<link rel='stylesheet' type='text/css' href="${relPath}${go:AddTimestampToHref('common/js/InspectorJSON/inspector_json.css')}" />
...
<%-- JAVASCRIPT --%>
	...
	<script type="text/javascript" src="${relPath}common/js/popup.js"></script>

	<script type="text/javascript" src="${relPath}common/js/jquery.validate-1.11.1.min.js"></script>
	<script type="text/javascript" src="${relPath}common/js/jquery.validate.custom.js"></script>
	
	<%--<script type="text/javascript" src="${relPath}common/js/simples/notify.min.js"></script>--%>
