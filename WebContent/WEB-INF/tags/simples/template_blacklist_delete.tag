...
<script id="simples-template-blacklist-delete" type="text/html">
...
<div class="simples-blacklist-modal">
	...
	<div class="simples-blacklist-modal-body">
		...
		{{ } }}
		<form id="simples-delete-blacklist" class="form-horizontal">
			...
			<div class="row text-right">
				<div class="col-xs-9  text-right">
					...
					<a data-provide="simples-blacklist-submit" class="btn btn-primary">Remove from Blacklist</a>
				</div>
			</div>
		</form>
	</div>
