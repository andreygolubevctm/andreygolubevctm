...
<go:script marker="onready">
	...
	CallNowPanel = {
		...
		renderDetail : function() {
			...
			$("#contact-panel").find(".row.mid").first().empty().append('<h3>Call Lifebroker Now<br /><span>1800 204 124</span></h3><a href="javascript:IPQuote.onRequestCallback();" id="request-callback" title="Click to receive call from Lifebroker"><span>Call Me Back</span></a><p>A Lifebroker consultant can call you back to discuss your options.</p>');
		},
