...
<go:script marker="onready">
	...
	CallNowPanel = {
		...
		renderDetail : function() {
			$("#contact-panel").find(".row.mid").first().empty().append('<h3>Call Now<br /><span>1800 204 124</span><br /><span class="contact_panel_small">To speak with a Lifebroker consultant</span></h3><span><strong>OR</strong></span> <a href="javascript:IPQuote.onRequestCallback();" id="request-callback" title="Click to receive call from Lifebroker"><span><img alt="" title="Get a call back" src="common/images/icons/phone-operator-white.png">&nbsp;Call Me Back</span></a>');
