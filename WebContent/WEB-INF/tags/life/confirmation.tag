			...
			<div class="right-panel">
				...
				<div class="right-panel-middle">
					<div class="panel nopad nobdr">
						<p><content:optin key="brandDisplayName" useSpan="true"/> is an online comparison website aimed at delivering our clients competitively priced yet comprehensive policies.  Information and quotes are provided by our trusted partners, Lifebroker Pty Ltd and Auto and General Services.</p>
					</div>
				</div>
