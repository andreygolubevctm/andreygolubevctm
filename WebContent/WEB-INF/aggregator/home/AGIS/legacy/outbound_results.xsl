						...
						<xsl:choose>
							<xsl:when test="coverAmounts/itemsAway='Y'">
								<personalEffects>
									...
									<bicyles>
										<xsl:choose>
											<xsl:when test="coverAmounts/specifyPersonalEffects = 'Y' and coverAmounts/specifiedPersonalEffects/bicycle!='0' and coverAmounts/specifiedPersonalEffects/bicycle!=''">
									...
									<musicalInstruments>
										<xsl:choose>
											<xsl:when test="coverAmounts/specifyPersonalEffects = 'Y' and coverAmounts/specifiedPersonalEffects/musical!='0' and coverAmounts/specifiedPersonalEffects/musical!=''">
									...
									<photoEquipment>
										<xsl:choose>
											<xsl:when test="coverAmounts/specifyPersonalEffects = 'Y' and coverAmounts/specifiedPersonalEffects/photo!='0' and coverAmounts/specifiedPersonalEffects/photo!=''">
									...
									<clothing>
										<xsl:choose>
											<xsl:when test="coverAmounts/specifyPersonalEffects = 'Y' and coverAmounts/specifiedPersonalEffects/clothing!='0' and coverAmounts/specifiedPersonalEffects/clothing!=''">
									...
									<jewelleryWatches>
										<xsl:choose>
											<xsl:when test="coverAmounts/specifyPersonalEffects = 'Y' and coverAmounts/specifiedPersonalEffects/jewellery!='0' and coverAmounts/specifiedPersonalEffects/jewellery!=''">
									...
									<sportEquipment>
										<xsl:choose>
											<xsl:when test="coverAmounts/specifyPersonalEffects = 'Y' and coverAmounts/specifiedPersonalEffects/sporting!='0' and coverAmounts/specifiedPersonalEffects/sporting!=''">
