...
<!-- IMPORTS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
	...
	<xsl:import href="../includes/greenstone_product_details.xsl"/>
...
<!-- PARAMETERS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
	...
	<!-- Temporary Hard Coding until Greenstone gives us some proper error information -->
			...
			<xsl:choose>
				<xsl:when test="$type != ''">
					<xsl:element name="{$type}">
						...
						<insuredValues></insuredValues> <!-- Greenstone don't pass this back.... -->
					</xsl:element>
				</xsl:when>
			</xsl:choose>
	</xsl:template>
