		...
		<results>
			<xsl:for-each select="a:QuoteResult/a:Quote">
				...
				<xsl:element name="price">
					...
					<underwriter>Greenstone Financial Services Pty Ltd ABN 78 090 584 473</underwriter>
