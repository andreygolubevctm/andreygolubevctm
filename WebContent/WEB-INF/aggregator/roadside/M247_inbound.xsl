		...
		<xsl:otherwise>
			<results>
				<xsl:call-template name="unavailable">
					<xsl:with-param name="productId">ROADSIDE-223</xsl:with-param>
				</xsl:call-template>
			</results>
		</xsl:otherwise>
		</xsl:choose>
		...
		<results>
			...
			<xsl:for-each select="result">
				...
				<xsl:element name="price">
					...
					<providerCode>M247</providerCode>
					<trackCode>42</trackCode>
					...
					<quoteUrl>https://www.motoring24-7.com.au/join/step1/</quoteUrl>
				</xsl:element>
			</xsl:for-each>
