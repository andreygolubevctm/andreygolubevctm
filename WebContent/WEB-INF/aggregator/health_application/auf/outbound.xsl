					...
					<request>
					  ...
					  <xsl:variable name="dependants" select="application/dependants" />
							...
							<xsl:if test="$srcElement/firstName!=''">
								...
								<Dependant>
									...
									<Relationship><xsl:choose>
										<xsl:when test="$srcElement/school=''">Child</xsl:when>
						...
						<xsl:choose>
							...
							<xsl:when test="fundData/extrasCoverName = '' and fundData/hospitalCoverName != ''">
						...
						<xsl:choose>
							...
							<xsl:otherwise>
								<xsl:if test="fundData/hospitalCoverName != '' and fundData/extrasCoverName != ''">
