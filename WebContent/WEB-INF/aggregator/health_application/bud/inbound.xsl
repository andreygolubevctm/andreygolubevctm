...
<!-- PARAMETERS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
	...
	<xsl:param name="fundid">bud</xsl:param>

<!-- IMPORTS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
	<xsl:variable name="fundErrors">
		<errors>
			<!-- BUD don't return error codes per se so just return the message -->
...
<!-- PRICES AVAILABLE ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
	<xsl:template match="/">
		<result>
			...
			<!-- Normal result -->
			<xsl:for-each select="/s:Envelope/s:Body/tem:SubmitMembershipTransactionUsingSTPResponse/tem:SubmitMembershipTransactionUsingSTPResult">
