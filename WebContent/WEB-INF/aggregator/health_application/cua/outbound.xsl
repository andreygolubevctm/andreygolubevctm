				...
				<MembershipApplication xmlns="http://www.hambs.com.au/MemberServices/MemberServices.xsd">
					...
					<Persons>
						<Person>
							...
							<xsl:if test="application/primary/firstname = ''">
								<xsl:message terminate="yes">
									firstname is mandatory
								</xsl:message>
							</xsl:if>
							<FirstName><xsl:value-of select="application/primary/firstname" /></FirstName>
							<xsl:if test="application/primary/surname = ''">
								<xsl:message terminate="yes">
							...
							<xsl:choose>
								<xsl:when test="$primaryFund !='NONE' and $primaryFund !=''">
									...
									<xsl:choose>
										<xsl:when test="previousfund/primary/memberID != ''">
						...
						<xsl:if test="application/partner/firstname != ''">
							<Person>
								...
								<xsl:when test="$partnerFund !='NONE'">
									...
									<xsl:choose>
										<xsl:when test="previousfund/partner/memberID != ''">
											<PreviousFundMemberNo>
					...
					<Contributions>
						...
						<xsl:choose>
							<xsl:when test="/health/payment/credit/policyDay != ''">
								<DebitOnDate><xsl:value-of select="/health/payment/credit/policyDay" /></DebitOnDate>
							</xsl:when>
