...
<!-- MAIN TEMPLATE ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
	<xsl:template match="/">
		...
		<xsl:otherwise>
			...
			<results>
				<xsl:call-template name="unavailable">
					<xsl:with-param name="productId">TRAVEL-37</xsl:with-param>
				</xsl:call-template>
			</results>
			<results>
				<xsl:call-template name="unavailable">
					<xsl:with-param name="productId">TRAVEL-38</xsl:with-param>
				</xsl:call-template>
			</results>
		</xsl:otherwise>
		</xsl:choose>
		...
		<results>	
			...
			<xsl:for-each select="result">
				...
				<xsl:element name="price">
					...
					<xsl:choose>
						<xsl:when test="@productId = 'TRAVEL-37'"><quoteUrl>https://travel.qbe.com/qbe/QBETravel?login=true%26aid=G6EPHBAYS3HJC5ADUZBO2I2IFM%26doc=4QAWJWCU2JJN2ABHQ44GJ6TUTGK6PTK556VN4DJ5IEQ7NYS5HO4Q</quoteUrl></xsl:when>
						<xsl:when test="@productId = 'TRAVEL-38'"><quoteUrl>https://travel.qbe.com/qbe/QBETravel?login=true%26aid=G6EPHBAYS3HJC5ADUZBO2I2IFM%26doc=4QAWJWCU2JJN2ABHQ44GJ6TUTGK6PTK556VN4DJ5IEQ7NYS5HO4Q</quoteUrl></xsl:when>	
						<xsl:otherwise>
							<quoteUrl>https://travel.qbe.com/qbe/QBETravel?login=true%26aid=G6EPHBAYS3HJC5ADUZBO2I2IFM%26doc=QQLCLVFKE6SLQRU5VFSJ2CAR5U</quoteUrl>
						</xsl:otherwise>
					</xsl:choose>			
				</xsl:element>		
			</xsl:for-each>
