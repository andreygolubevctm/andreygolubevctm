...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	<xsl:template name="getBenefits">
		...
		<xsl:choose>
			...
			<xsl:when test="$planId = 53430 or $planId = 53431">
					<cxdfee>
			...
			<xsl:when test="$planId = 53433 or $planId = 53434">
					<cxdfee>
						<label>Cancellation Fees</label>
						<desc>Cancellation Fees and Lost Deposits</desc>
						<value>5000</value>
			...
			<xsl:when test="$planId = 53436 or $planId = 53437">
					<cxdfee>
						<label>Cancellation Fees</label>
						<desc>Cancellation Fees and Lost Deposits</desc>
						<value>0</value>
			...
			<xsl:when test="$planId = 53439 or $planId = 53440 or $planId = 53441 or $planId = 53442 or $planId = 53443 or $planId = 53444">
				<cxdfee>
					<label>Cancellation Fees</label>
					<desc>Cancellation Fees and Lost Deposits</desc>
					<xsl:choose>
						<xsl:when test="$planId = 53439">
							<value>500</value>
							<text>$500</text>
						</xsl:when>
						<xsl:when test="$planId = 53440">
							<value>1000</value>
							<text>$1,000</text>
						</xsl:when>
						<xsl:when test="$planId = 53441">
							<value>1500</value>
							<text>$1,500</text>
						</xsl:when>
						<xsl:when test="$planId = 53442">
							<value>2000</value>
							<text>$2,000</text>
						</xsl:when>
						<xsl:when test="$planId = 53443">
							<value>2500</value>
							<text>$2,500</text>
						</xsl:when>
						<xsl:when test="$planId = 53444">
							<value>3000</value>
							<text>$3,000</text>
						</xsl:when>
					</xsl:choose>
