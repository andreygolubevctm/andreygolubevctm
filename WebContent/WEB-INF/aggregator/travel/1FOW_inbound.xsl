		...
		<results>
			<xsl:for-each select="quote">
				<xsl:variable name="uniqueId">
					<xsl:choose>
						<xsl:when test="coverType/code = 'J'">19</xsl:when>
						<xsl:when test="coverType/code = 'G'">20</xsl:when>
						<xsl:when test="coverType/code = 'H'">21</xsl:when>
						<xsl:when test="coverType/code = 'I'">22</xsl:when>
						<xsl:when test="coverType/code = 'K'">23</xsl:when>
					</xsl:choose>
				</xsl:variable>
