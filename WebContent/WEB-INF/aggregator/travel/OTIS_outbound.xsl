...
<!-- LOCAL VARIABLES ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
		...
		<xsl:variable name="region">
			<xsl:choose>
				...
				<!-- India -->
				<xsl:when test="destinations/as/in !='' ">EA</xsl:when>
				
				<!-- Thailand -->
				<xsl:when test="destinations/as/th !='' ">EA</xsl:when>
				<xsl:when test="destinations/pa/in !='' ">EA</xsl:when>								
				<xsl:when test="destinations/eu">EA</xsl:when>
