<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://pricingapi.agaassistance.com.au/PricingRequest.xsd">

	<!-- MAIN TEMPLATE ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
	<!-- This solution blows but it's required. the xmlns namespace is required for the Allianz based webservices. If not included it adds an extra xmnls="" attribute to the country code -->
