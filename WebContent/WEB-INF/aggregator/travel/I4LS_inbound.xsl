	...
	<xsl:template match="/results/result | error">
		...
		<xsl:otherwise>
				<xsl:call-template name="unavailable">
					<xsl:with-param name="productId">TRAVEL-90</xsl:with-param>
				</xsl:call-template>
		</xsl:otherwise>
		</xsl:choose>
	</xsl:template>
		...
		<results>	
			...
			<xsl:for-each select="result">
				...
				<xsl:element name="price">
					...
					<xsl:choose>
						<xsl:when test="@productId = 'TRAVEL-90'"><quoteUrl>https://www.insure4less.com.au/travel.php?fromaffiliateid=216</quoteUrl></xsl:when>
						<xsl:when test="@productId = 'TRAVEL-91'"><quoteUrl>https://www.insure4less.com.au/travel.php?fromaffiliateid=216</quoteUrl></xsl:when>	
						<xsl:when test="@productId = 'TRAVEL-92'"><quoteUrl>https://www.insure4less.com.au/travel.php?fromaffiliateid=216</quoteUrl></xsl:when>	
						<xsl:otherwise>
							<quoteUrl>https://www.insure4less.com.au/multitravel.php?fromaffiliateid=216</quoteUrl>
						</xsl:otherwise>
					</xsl:choose>
				</xsl:element>
			</xsl:for-each>
