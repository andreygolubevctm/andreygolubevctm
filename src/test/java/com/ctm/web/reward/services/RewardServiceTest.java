...
public class RewardServiceTest {
	...
	public void roundupMinutes() throws Exception {
		RewardService reward = new RewardService(mock(TransactionDetailsDao.class), mock(Client.class), mock(RewardCampaignService.class), mock(ApplicationService.class));
