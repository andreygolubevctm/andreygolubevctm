...
public class EmailFunctionsTest {
    ...
    public void whenListOfStringsWithHtmlTags_thenStripWhilstMaintainingSpacesInEachElement() {
        ...
        List<String> result = EmailFunctions.stripHtmlFromStrings.apply(testStrings);
    ...
    public void whenStringContainsNestedHtmlElements_thenReturnOnlyText() {
        ...
        String result = EmailFunctions.stripHtml.apply(testStrings);
    ...
    public void whenListElementsAreNull_thenSafelyHandleNull() {
        ...
        List<String> result = EmailFunctions.stripHtmlFromStrings.apply(Arrays.asList(testStrings));
    ...
    public void givenAnInvalidBigDecimalString_thenReturnZero() {
        assertThat(EmailFunctions.bigDecimalOrZero.apply("NaN"), equalTo(BigDecimal.ZERO));
    }

    @Test
    public void givenAvalidBigDecimalString_thenReturnAsBigDecimal() {
        assertThat(EmailFunctions.bigDecimalOrZero.apply("3.14"), equalTo(BigDecimal.valueOf(3.14)));
    }
