...
public class RequestAdapterTest {
    ...
    public void testCreateFundDataEmpty() throws Exception {
        final com.ctm.web.health.apply.model.request.fundData.FundData result = RequestAdapter.createFundData(Optional.empty());
        assertNotNull(result);
    ...
    public void testCreateFundData() throws Exception {
        ...
        final com.ctm.web.health.apply.model.request.fundData.FundData result = RequestAdapter.createFundData(Optional.ofNullable(healthQuote));
        assertNotNull(result);
    ...
    public void testCreatePaymentEmpty() throws Exception {
        final com.ctm.web.health.apply.model.request.payment.Payment result = RequestAdapter.createPayment(Optional.empty());
        assertNull(result);
    }
    ...
    public void testCreatePayment() throws Exception {
        ...
        when(healthQuote.getPayment()).thenReturn(payment);
        when(payment.getDetails()).thenReturn(paymentDetails);
        final com.ctm.web.health.apply.model.request.payment.Payment result = RequestAdapter.createPayment(Optional.ofNullable(healthQuote));
        assertNotNull(result);
    ...
    public void testCreateDependantsEmpty1() throws Exception {
        ...
        final List<com.ctm.web.health.apply.model.request.application.dependant.Dependant> result = RequestAdapter.createDependants(Optional.of(dependants));
        assertNotNull(result);
