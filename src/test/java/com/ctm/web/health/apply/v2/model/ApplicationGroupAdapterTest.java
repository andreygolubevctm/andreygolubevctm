...
import com.ctm.web.health.apply.v2.model.request.application.situation.Situation;
...
public class ApplicationGroupAdapterTest {
    ...
    public void testCreateApplicationGroup() throws Exception {
        ...
        final PreviousFund previousFund = mock(PreviousFund.class);
    ...
    public void testPreviousFundEmpty() throws Exception {
        final com.ctm.web.health.apply.v2.model.request.application.applicant.previousFund.PreviousFund previousFund = ApplicationGroupAdapter.createPreviousFund(Optional.empty());
    ...
    public void testPreviousFund() throws Exception {
        ...
        final com.ctm.web.health.apply.v2.model.request.application.applicant.previousFund.PreviousFund previousFund = ApplicationGroupAdapter.createPreviousFund(Optional.ofNullable(fund));
    ...
    public void testCreateDependantsEmpty() throws Exception {
        assertNull(com.ctm.web.health.apply.v2.model.ApplicationGroupAdapter.createDependants(Optional.empty()));
    }

    @Test
    public void testCreateDependantsEmpty1() throws Exception {
        final Dependants dependants = mock(Dependants.class);
        final List<com.ctm.web.health.apply.v2.model.request.application.dependant.Dependant> result = ApplicationGroupAdapter.createDependants(Optional.of(dependants));
        assertNotNull(result);
