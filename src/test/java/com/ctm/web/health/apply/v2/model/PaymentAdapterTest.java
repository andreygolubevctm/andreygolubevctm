...
public class PaymentAdapterTest {
    ...
    public void testCreatePaymentEmpty() throws Exception {
        final com.ctm.web.health.apply.v2.model.request.payment.Payment result = PaymentAdapter.createPayment(Optional.empty());
        assertNull(result);
    }
    ...
    public void testCreatePayment() throws Exception {
        ...
        final com.ctm.web.health.apply.v2.model.request.payment.Payment result = PaymentAdapter.createPayment(Optional.ofNullable(healthQuote));
