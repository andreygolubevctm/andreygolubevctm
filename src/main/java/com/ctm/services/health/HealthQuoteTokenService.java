...
import com.ctm.model.resultsData.BaseResultObj;
 ...
 */
public class HealthQuoteTokenService {
    ...
    public HealthQuoteTokenService() {
        sessionDataService = new SessionDataService();
        this.requestService = new RequestService(Vertical.VerticalType.HEALTH );
    }

    public HealthQuoteTokenService(HealthTokenValidationService tokenService, RequestService requestService) {
        sessionDataService = new SessionDataService();
