...
public class LifebrokerLeadRequest {
    ...
    public LifebrokerLeadRequest(String affiliateId, String email, String phone, String postcode, String name, String mediaCode, String callTime) {
        this.contact = new LifebrokerLeadRequestContact(affiliateId, email, phone, postcode, new LifebrokerLeadRequestClient(name), new LifebrokerLeadRequestAdditional(mediaCode, callTime));
    }
