...
public enum NhbEligibilitySubReasonID {
    ...
    NhbEligibilitySubReasonID(final String code, final String description) {
        this.code = code;
    ...
    @JsonCreator
    public static NhbEligibilitySubReasonID findByCode(final String code) {
        if(code == null) {
            return UNKOWN;
        }
        for (final NhbEligibilitySubReasonID t : NhbEligibilitySubReasonID.values()) {
    ...
    public static NhbEligibilitySubReasonID fromValue(final String v) {
        return findByCode(v);
    }
