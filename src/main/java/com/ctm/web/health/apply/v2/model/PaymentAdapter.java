...
import com.ctm.web.health.apply.v2.model.request.payment.Claims;
import com.ctm.web.health.apply.v2.model.request.payment.bank.account.*;
import com.ctm.web.health.apply.v2.model.request.payment.common.ExpiryMonth;
import com.ctm.web.health.apply.v2.model.request.payment.common.ExpiryYear;
import com.ctm.web.health.apply.v2.model.request.payment.credit.*;
import com.ctm.web.health.apply.v2.model.request.payment.credit.Number;
import com.ctm.web.health.apply.v2.model.request.payment.details.*;
import com.ctm.web.health.apply.v2.model.request.payment.medicare.MedicareNumber;
import com.ctm.web.health.apply.v2.model.request.payment.medicare.MiddleInitial;
import com.ctm.web.health.apply.v2.model.request.payment.medicare.Position;
...
public class PaymentAdapter {
    ...
    public static com.ctm.web.health.apply.v2.model.request.payment.Payment createPayment(Optional<HealthQuote> quote) {
        final Optional<com.ctm.web.health.model.form.Payment> payment = quote.map(HealthQuote::getPayment);
        if (payment.isPresent()) {
            return new com.ctm.web.health.apply.v2.model.request.payment.Payment(
    ...
    protected static com.ctm.web.health.apply.v2.model.request.payment.medicare.Medicare createMedicare(Optional<com.ctm.web.health.model.form.Medicare> medicare) {
        if (medicare.isPresent()) {
            return new com.ctm.web.health.apply.v2.model.request.payment.medicare.Medicare(
                    ...
                    medicare.map(com.ctm.web.health.model.form.Medicare::getExpiry)
                            .map(e -> {
                                ...
                                return new com.ctm.web.health.apply.v2.model.request.payment.common.Expiry(
    ...
    protected static com.ctm.web.health.apply.v2.model.request.payment.bank.Bank createBank(Optional<com.ctm.web.health.model.form.Payment> payment) {
        ...
        if ("ba".equals(paymentType)) {
            return new com.ctm.web.health.apply.v2.model.request.payment.bank.Bank(
                    createAccount(bank),
            ...
            if (payment.map(com.ctm.web.health.model.form.Payment::getGateway)
                ...
                return new GatewayCreditCard(
                        ...
                        nab.map(Nab::getCardNumber)
                                ...
                                .orElse(null),
                        nab.map(n ->
                                new com.ctm.web.health.apply.v2.model.request.payment.common.Expiry(
                        ...
                        gateway.map(Gateway::getExpiry)
                                .map(e -> {
                                    ...
                                    if (params != null && params.length == 2) {
                                        return new com.ctm.web.health.apply.v2.model.request.payment.common.Expiry(new ExpiryMonth(params[0]), new ExpiryYear(params[1]));
                                    } else {
                                        return null;
                                    }
                                }).orElse(null),
