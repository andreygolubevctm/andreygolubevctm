...
public class HealthEmailService extends EmailServiceHandler implements BestPriceEmailHandler, ProductBrochuresEmailHandler, ApplicationEmailHandler {
	...
	private String sendProductBrochureEmail(HttpServletRequest request, String emailAddress, long transactionId, boolean blockEmailSending) throws SendEmailException {
		...
		accessTouchService.recordTouchWithProductAndProvider(emailBrochureRequest.transactionId, Touch.TouchType.BROCHURE.getCode(), null, productID, emailBrochureRequest.productName, emailBrochureRequest.provider);
	...
	private EmailEventRequest buildApplicationEmailModel(EmailMaster emailDetails, long transactionId, String productId, HttpServletRequest request) throws SendEmailException {
		...
		emailEventRequest.setStartDate(getParamSafely(dataBucket, "health/payment/details/start"));
		emailEventRequest.setPaymentDateBank(getParamSafely(dataBucket, "health/payment/bank/policyDay"));
		emailEventRequest.setPaymentDateCreditCard(getParamSafely(dataBucket, "health/payment/credit/policyDay"));
		...
		emailEventRequest.setPrimaryHasDifferentProviders(getParamSafely(dataBucket, "health/application/primary/cover/differentProviders") != null ? getParamSafely(dataBucket, "health/application/primary/cover/differentProviders") : getParamSafely(dataBucket, "health/previousfund/primary/differentFunds"));
		...
		emailEventRequest.setPartnerHasDifferentProviders(getParamSafely(dataBucket, "health/application/partner/cover/differentProviders") != null ? getParamSafely(dataBucket, "health/application/partner/cover/differentProviders") : getParamSafely(dataBucket, "health/previousfund/partner/differentFunds"));
		...
		emailEventRequest.setPartnerExtrasFundName(getParamSafely(dataBucket, "health/application/partner/extras/fundName") != null ? getParamSafely(dataBucket, "health/application/partner/extras/fundName") : getParamSafely(dataBucket, "health/previousfund/partner/extras/fundName"));
		emailEventRequest.setPartnerExtrasMemberID(getParamSafely(dataBucket, "health/application/partner/extras/memberID") != null ? getParamSafely(dataBucket, "health/application/partner/extras/memberID") : getParamSafely(dataBucket, "health/previousfund/partner/extras/memberID"));
