...
public class HealthEmailModel {
    ...
    public String getP1ExcessPerPerson() {
        return p1ExcessPerPerson;
    }

    public void setP1ExcessPerPerson(String p1ExcessPerPerson) {
        this.p1ExcessPerPerson = p1ExcessPerPerson;
    }

    public String getP1ExcessPerPolicy() {
        return p1ExcessPerPolicy;
    }

    public void setP1ExcessPerPolicy(String p1ExcessPerPolicy) {
    ...
    public String getP1PremiumTotal() {
        return p1PremiumTotal;
    }

    public void setP1PremiumTotal(String p1PremiumTotal) {
        this.p1PremiumTotal = p1PremiumTotal;
    }

    public String getP2PremiumTotal() {
        return p2PremiumTotal;
    }

    public void setP2PremiumTotal(String p2PremiumTotal) {
        this.p2PremiumTotal = p2PremiumTotal;
    }

    public String getP3PremiumTotal() {
        return p3PremiumTotal;
    }

    public void setP3PremiumTotal(String p3PremiumTotal) {
        this.p3PremiumTotal = p3PremiumTotal;
    }

    public String getP4PremiumTotal() {
        return p4PremiumTotal;
    }

    public void setP4PremiumTotal(String p4PremiumTotal) {
        this.p4PremiumTotal = p4PremiumTotal;
    }

    public String getP5PremiumTotal() {
        return p5PremiumTotal;
    }

    public void setP5PremiumTotal(String p5PremiumTotal) {
