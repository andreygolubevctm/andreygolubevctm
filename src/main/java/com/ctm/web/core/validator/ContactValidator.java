...
public class ContactValidator extends CommonRouter {
    ...
    public static void validateContact(HttpServletRequest request, String verticalCode, String contact) {
        try {
            if (StringUtils.isNotBlank(contact)) {
                ...
                contactValidatorService.validateContact(initRouter(request, verticalType), verticalType, Contact.instanceOf(contact),
