...
public class Touch extends AbstractJsonModel {
	...
	public static enum TouchType {
		...
		NEW ("New quote" , "N", ""),
		SUBMITTED ("Submit", "P", ""),
		PRICE_PRESENTATION ("Price presentation" , "R", "'MoreInfo'"),
		CALL_DIRECT_REQUEST("Call direct requested", "CDR", "'OHR','R','MoreInfo'"),
		CALL_BACK_REQUEST("Call back requested", "CMR", "'CDR','OHR','R','MoreInfo'"),
		ONLINE_HANDOVER_REQUEST("Online handover requested", "OHR", "'R','MoreInfo'"),
