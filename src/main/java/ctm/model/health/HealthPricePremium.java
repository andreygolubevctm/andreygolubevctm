...
public class HealthPricePremium {
	...
	public void setAnnualLhc(double annualLhc) {
		this.annualLhc = annualLhc;
	}
	...
	public double getHalfYearlyLhc() {
		return halfYearlyLhc;
	}
	public void setHalfYearlyLhc(double halfYearlyLhc) {
		this.halfYearlyLhc = halfYearlyLhc;
	}
	...
	public double getQuarterlyLhc() {
		return quarterlyLhc;
	}
	public void setQuarterlyLhc(double quarterlyLhc) {
		this.quarterlyLhc = quarterlyLhc;
	}
	...
	public double getMonthlyLhc() {
		return monthlyLhc;
	}
	public void setMonthlyLhc(double monthlyLhc) {
		this.monthlyLhc = monthlyLhc;
	}
	...
	public double getFortnightlyLhc() {
		return fortnightlyLhc;
	}
	public void setFortnightlyLhc(double fortnightlyLhc) {
		this.fortnightlyLhc = fortnightlyLhc;
	}
	public double getFortnightlyPremium() {
		return fortnightlyPremium;
	}
	public void setFortnightlyPremium(double fortnightlyPremium) {
		this.fortnightlyPremium = fortnightlyPremium;
	}
	public double getWeeklyLhc() {
		return weeklyLhc;
	}
	public void setWeeklyLhc(double weeklyLhc) {
