...
<c:set var="xmlData">
	...
	<data>
		...
		<whatsNext><![CDATA[ ${providerContentService.getProviderContentText(pageContext.getRequest(), data.health.application.providerName, data.current.brandCode, "NXO")} ]]></whatsNext>
