...
<c:choose>
	...
	<c:choose>
		<c:when test="${validCredentials}">
			...
			${logger.debug('RETRIEVE QUOTES COMPILED: authenticatedData.tmp={} tmp/previousQuotes={},{}', authenticatedData.tmp, authenticatedData['tmp/previousQuotes'], log:kv('email',emailAddress))}
