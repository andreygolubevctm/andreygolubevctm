...
var healthFunds_QCH = {
	...
	set: function() {
		...
		if (!$('body').hasClass('injectingFund')) {
			...
			meerkat.modules.healthDependants.updateConfig({ showFullTimeField :true, showSchoolFields:true, 'schoolMin':21, 'schoolMax':24, showSchoolIdField:false, showApprenticeField:true});
