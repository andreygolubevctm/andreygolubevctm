...
(function(factory){
			...
			switch (this.viewMode){
				case 0:
					...
					for (var i = 0; i < this.o.numberOfMonths; i++) {
						...
						if (this.o.startDate !== -Infinity && year <= this.o.startDate.getUTCFullYear() && month <= this.o.startDate.getUTCMonth() && month <= this.o.startDate.getUTCMonth() || (this.o.numberOfMonths > 1 && i != 0)) {
							...
							if (this.o.allowHeaderStyling === true) {
								$prevBtn.html(this.o.templates.leftArrow);
							}
						...
						if (this.o.endDate !== Infinity && year >= this.o.endDate.getUTCFullYear() && month >= this.o.endDate.getUTCMonth() && month >= this.o.endDate.getUTCMonth()
							...
							if (this.o.allowHeaderStyling === true) {
								$nextBtn.html(this.o.templates.rightArrow);
							}
				...
				case 4:
					...
					if ((this.o.startDate !== -Infinity && year <= this.o.startDate.getUTCFullYear() || this.o.maxViewMode < 2) && year <= this.o.startDate.getUTCFullYear()){
						if (this.o.allowHeaderStyling === true) {
							$prevBtn.html("&nbsp;");
						}
						$prevBtn.css({visibility: 'hidden'});
	...
	var DPGlobal = {
		...
		headTemplate: '<thead>'+
		'<tr>'+
		'<th class="prev">"+this.o.templates.leftArrow+"</th>'+
		'<th colspan="5" class="datepicker-switch"></th>'+
		'<th class="next">"+this.o.templates.rightArrow+"</th>'+
		'</tr>'+
		'</thead>',
