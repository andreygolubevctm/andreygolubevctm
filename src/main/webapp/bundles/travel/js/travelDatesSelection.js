...
;(function($, undefined) {
	...
	function initTravelDatesSelection(){
		...
		$(document).ready(function(){
			...
			$fromDateInput.datepicker({ orientation: "bottom", numberOfMonths: 2, allowHeaderStyling: true});
			$toDateInput.datepicker({ orientation: "bottom", numberOfMonths: 2, allowHeaderStyling: true });
