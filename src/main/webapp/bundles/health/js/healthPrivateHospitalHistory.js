(function ($, undefined) {
    ...
    function _setupFields() {
        ...
        $elements = {
            primary: _createFieldReferences('health_healthCover_', 'primary', '_fundHistory_'),
            partner: _createFieldReferences('health_healthCover_', 'partner', '_fundHistory_')
        };
    }
    ...
    function _addbtn_EventListener(applicant) {
        ...
        if (isDataTableValidationSuccessful) {
            ...
            meerkat.modules.health.loadRatesBeforeResultsPage(true, function (rates) {
                meerkat.modules.healthAboutYou.setRebateRates(rates);
            });
        }
    }
    ...
    function _displayCoverDatesDataTable(applicant) {
        ...
        if (applicant === 'partner') {
            applicantValidationCheck = (applicantValidationCheck && meerkat.modules.health.hasPartner());
        }
