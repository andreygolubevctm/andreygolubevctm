;(function ($, undefined) {
  ...
  function hideResultsFilter() {
    var rabdResult = !Results.getReturnedResults() ? undefined : Results.getReturnedResults().find(function(result) { return result.custom.reform.yad === "R" && result.premium.monthly.abd > 0; });
