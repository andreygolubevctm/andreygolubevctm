;(function ($) {
    ...
    function getPricePremium(frequency, availablePremiums, mode) {
        ...
        result.lhcFreePriceMode = typeof mode === "undefined" || (mode !== "lhcInc" || prem.lhcfreepricing.indexOf('LHC loading may increase the premium') === 0 && meerkat.modules.healthLHC.getNewLHC() === null);
