;(function($, undefined){
	...
	function addPHGImpressionTracking() {
		if (meerkat.site.PHGPostImpressionsEnabled === true && typeof meerkat.site.PHGPostImpressions !== 'undefined'  && typeof meerkat.site.PHGPostImpressions.url !== 'undefined' && typeof meerkat.site.PHGPostImpressions.partnerValues !== 'undefined') {
			var links = "";
