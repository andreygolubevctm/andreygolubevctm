	...
	function init(){
		...
		jQuery(document).ready(function($) {
			...
			if(meerkat.site.pageAction != "confirmation"){
				...
				meerkat.messaging.subscribe(meerkatEvents.healthResults.PREMIUM_UPDATED, function(selectedProduct, showIncPrice){
					// This should be called when the user updates their premium on the payment step.
					onProductPremiumChange(selectedProduct, showIncPrice);
				});
