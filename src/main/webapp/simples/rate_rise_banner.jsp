...
<layout_v1:simples_page fullWidth="true">
    ...
    <jsp:body>
        <div class="sortable-header data-sorter container-fluid" data-refreshcallback="meerkat.modules.adminRateRiseBanner.refresh">
            <div class="container">
                <div class="row">
                    <ul>
                        <li class="col-lg-6">
        ...
        <div id="rate-rise-banner-container" class="container sortable-results-container">
            <div class="row">
                <div class="col-sm-12">
                    <h1>Rate Rise Label</h1>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div id="current-rate-rise-banner-container" class="sortable-results-table"></div>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-12 header">
                ...
                <div class="col-sm-12">
                    <div id="future-rate-rise-banner-container" class="sortable-results-table" style="display: none;"></div>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-12 header">
                ...
                <div class="col-sm-12">
                    <div id="past-rate-rise-banner-container" class="sortable-results-table" style="display: none;"></div>
                </div>
            </div>
        </div>
    </jsp:body>
...
<script id="rate-rise-banner-modal-template" class="crud-modal-template" type="text/html">
    <div class="row">
        <div class="col-sm-12">
            <br>
            {{ if(data.modalAction === "edit") { }}
            <h1>Edit Rate Rise Label</h1>
            <input type="hidden" name="textId" value="{{= data.textId }}">
            {{ } else if(data.modalAction === "clone") { }}
            <h1>Clone Rate Rise Label</h1>
            {{ } else { }}
            <h1>Create Content</h1>
            {{ } }}
            <input type="hidden" name="textType" value="rateRiseBanner">
        </div>
    </div>
