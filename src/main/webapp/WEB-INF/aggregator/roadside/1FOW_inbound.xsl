		...
		<xsl:otherwise>
			<results>
				<xsl:call-template name="unavailable">
					<xsl:with-param name="productId">ROADSIDE-31</xsl:with-param>
				</xsl:call-template>
			</results>
		</xsl:otherwise>
		</xsl:choose>
		...
		<results>
			...
			<xsl:for-each select="result">
				...
				<xsl:element name="price">
					...
					<providerCode>1FOW</providerCode>
					<trackCode>17</trackCode>
