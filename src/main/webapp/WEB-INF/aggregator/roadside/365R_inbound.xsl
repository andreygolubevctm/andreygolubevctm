		...
		<results>
			...
			<xsl:for-each select="result">
				...
				<xsl:element name="price">
					...
					<quoteUrl>https://buy.365roadsideassistance.com/plans/<xsl:value-of select="$productString" />-annual?utm_source=comparethemarket%26utm_medium=refer%26utm_campaign=ctm<xsl:value-of select="$productString" /></quoteUrl>
				</xsl:element>
			</xsl:for-each>
