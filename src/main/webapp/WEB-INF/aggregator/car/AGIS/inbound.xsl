	...
	<xsl:template name="validateResponse">
		...
		<xsl:if test="/soapenv:Envelope/soapenv:Body/response/quoteList/quote">
			<xsl:choose>
				...
				<xsl:when test="not(/soapenv:Envelope/soapenv:Body/response/quoteList/quote/offlinePrice) and (/soapenv:Envelope/soapenv:Body/response/quoteList/quote/headlineOffer = 'OFFLINE')">
				...
				<xsl:otherwise>
					...
					<xsl:if test="/soapenv:Envelope/soapenv:Body/response/quoteList/quote/offlinePrice">
