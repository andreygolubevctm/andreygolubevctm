...
<field_v1:hidden xpath="${xpath}" defaultValue="" />
<c:set var="xpathSourceid" value="${root}/sourceid" />
<c:set var="xpathMedium" value="${root}/medium" />
<field_v1:hidden xpath="${xpathSourceid}" defaultValue="${referralTracking.getAndSetUtmSource(pageContext.request,  data, root)}" />
<field_v1:hidden xpath="${xpathMedium}" defaultValue="${referralTracking.getAndSetUtmMedium(pageContext.request,  data, root)}" />
<field_v1:hidden xpath="${root}/referer" defaultValue="${referralTracking.getRefererUrl(pageContext.request)}" />
...
<field_v1:hidden xpath="${xpathcl}" defaultValue="" />
