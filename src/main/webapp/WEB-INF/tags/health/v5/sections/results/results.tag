...
<layout_v1:results_template xsResultsColumns="2" resultsContainerClassName=" affixOnScroll sessioncamignorechanges ">
    ...
    <jsp:attribute name="sidebarColumnRight">
        ...
        <health_v5_results:filters_benefits />
        <health_v5_results:filters_template />
    ...
    <jsp:attribute name="hiddenInputs">
        ...
        <field_v1:hidden xpath="health/coverLevel" defaultValue="5" />
    ...
    <jsp:body>
        ...
        <health_v5_results:brochure_template />
        ...
        <health_v5_refine_results:refine_results />
