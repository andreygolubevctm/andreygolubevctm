...
<simples:dialogue id="97" vertical="health" className="simples-dialogue-hospital-cover simples-dialog-nextgenoutbound simples-dialog-nextgencli classification-nonPublic" />
