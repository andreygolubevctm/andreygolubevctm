...
<form_v3:row fieldXpath="${fieldXpath}input" label="BSB" isNestedField="${not useValidator}" hideHelpIconCol="${true}" smRowOverride="6">
...
<form_v3:row fieldXpath="${fieldXpath}" label="Account Number" isNestedField="${not useValidator}" hideHelpIconCol="${true}" smRowOverride="6" className="${className}">
