...
<form_v3:row fieldXpath="${fieldXpath}input" label="BSB" isNestedField="${empty callCentre}" hideHelpIconCol="${true}" smRowOverride="6">
...
<form_v3:row fieldXpath="${fieldXpath}" label="Account Number" isNestedField="${empty callCentre}" hideHelpIconCol="${true}" smRowOverride="6" className="${className}">
