...
<c:choose>
	<c:when test="${environmentService.getEnvironmentAsString() == 'localhost' || environmentService.getEnvironmentAsString() == 'NXI' || environmentService.getEnvironmentAsString() == 'NXS' || environmentService.getEnvironmentAsString() == 'NXQ'}">
