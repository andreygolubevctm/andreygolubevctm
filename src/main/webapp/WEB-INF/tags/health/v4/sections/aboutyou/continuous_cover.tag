...
<form_v4:row label="Have you had continuous hospital cover since 1 July ${continuousCoverYear} or 1 July following your 31st birthday?<span class='help-icon-with-label'><a href='javascript:void(0);' class='help-icon icon-info' data-content='helpid:573' data-toggle='popover' tabindex='-1'><span class='text-hide'>Need Help?</span></a></span>" fieldXpath="${fieldXpath}" id="health-continuous-cover-primary" className="health-your_details-opt-group lhcRebateCalcTrigger">
