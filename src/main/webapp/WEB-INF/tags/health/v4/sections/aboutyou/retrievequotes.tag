...
<div class="retrieveQuotes">
    ...
    <a href="${pageSettings.getBaseUrl()}retrieve_quotes.jsp" target="_blank" class="btn btn-secondary" <field_v1:analytics_attr analVal="nav link" quoteChar="\"" />>Retrieve quote</a>
</div>