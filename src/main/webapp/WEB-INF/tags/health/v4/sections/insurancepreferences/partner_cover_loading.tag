...
<form_v4:row label="Has your partner had continuous hospital cover since 1 July ${continuousCoverYear} or 1 July following their 31st birthday?  <a href='javascript:;' class='help_icon floatLeft' data-content='helpid:239' data-content-replace='{{year}},${continuousCoverYear}' data-toggle='popover'>learn more</a>" fieldXpath="${fieldXpath}" id="health-continuous-cover-partner" className="health-your_details-opt-group partner lhcRebateCalcTrigger">
