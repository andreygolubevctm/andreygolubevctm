...
<div id="${name}" class="health_popup_payment_ipp hidden" data-provide="payment-ipp">
    ...
    <div class="bambora-card-registration-message">
        We now need to register your credit card through Bambora Custom Checkout in order to process your payment.
        Please be assured that your personal and financial information is treated as highly confidential and
        stored in accordance with data protection regulations.
    </div>
