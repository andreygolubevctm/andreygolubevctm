...
<form_v4:row label="Have you had continuous hospital cover since 1 July ${continuousCoverYear} or 1 July following your 31st birthday? <a href='javascript:;' class='help_icon floatLeft' data-content='helpid:239' data-content-replace='{{year}},${continuousCoverYear}' data-toggle='popover'>learn more</a>" fieldXpath="${fieldXpath}" id="health-continuous-cover-primary" className="health-your_details-opt-group lhcRebateCalcTrigger">
