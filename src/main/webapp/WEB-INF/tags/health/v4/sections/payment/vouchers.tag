...
<c:choose>
    <c:when test="${vouchersJourneyOn}">
        ...
        <div id="healthVouchers">
            <form_v4:row label="${openingQuestion}" fieldXpath="${fieldXpath}" className="healthVoucherAvailableRow">
            ...
            <div class="voucherIsAvailable">
                ...
                <form_v4:row label="Voucher type?" fieldXpath="${fieldXpath}" className="healthVoucherTypeRow">
                ...
                <div class="voucher other">
                    <health_v4_payment:voucher xpath="${xpath}" />
                </div>
            </div>
        </div>
    </c:when>
