...
<core_v1:js_template id="results-features-extras-template">
    ...
    <div class="cell category">
        <div class="content isMultiRow" data-featureId="99999">
            {{ if (!onlyHasOneBenefit) { }}<a data-toggle="popover" data-adjust-y="5" data-trigger="click" data-my="top center" data-at="top center" data-content="{{= popoverContent }}" data-class="resultsOtherBenefitsTooltip">{{= availableBenefits[0].safeName }} and {{= (availableBenefits.length - 1) }} more</a>
