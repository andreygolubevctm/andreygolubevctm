...
<form_v4:fieldset legend="Your Partner's Details" id="partnerContainer">
    ...
    <form_v4:row fieldXpath="${fieldXpath}" label="Tell us the start and end dates of private hospital cover your partner has held in the past, and we will calculate any Lifetime Health Cover that may be applied to your premium" id="partnerFundHistory" className="changes-premium hidden-toggle" rowContentClass="row">
