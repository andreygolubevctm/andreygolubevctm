...
<form_v4:row hideRowBorder="true" label="Does your current health cover include an Age-Based Discount?" subLabel="${abdSubLabel}" id="${name}_primaryhasABD" fieldXpath="${fieldXpath}"  className="lhcRebateCalcTrigger primaryHasABD hidden">
	<field_v2:array_radio items="Y=Yes,N=No" style="group" xpath="${fieldXpath}" title="- Does your current health cover include an Age-Based Discount?" id="primary_abd_health_cover" className="health-cover_details_abd_current" required="true" />
