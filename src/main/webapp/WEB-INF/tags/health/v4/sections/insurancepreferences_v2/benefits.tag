...
<form_v2:fieldset legend="Help us find the right cover for you" postLegend="${benefitsIntroCopy}" className="mainBenefitHeading_v2">
...
<c:forEach items="${resultTemplateItems}" var="selectedValue">
	<health_v4_insuranceprefs_v2:benefitsItem item="${selectedValue}"  />
</c:forEach>
</div>
