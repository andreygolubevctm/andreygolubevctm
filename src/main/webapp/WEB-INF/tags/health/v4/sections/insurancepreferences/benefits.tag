...
<form_v2:fieldset legend="What would you like covered in your new health insurance policy?" postLegend="Select all the benefits you would like covered in your new health insurance policy. We've made an effort to highlight some of the more common inclusions below, to help you choose. If a particular treatment is important to you, check the policy brochure before you purchase to make sure it is covered." className="mainBenefitHeading">
