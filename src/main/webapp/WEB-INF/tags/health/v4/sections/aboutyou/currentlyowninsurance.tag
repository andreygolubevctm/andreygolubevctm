...
<form_v4:row hideRowBorder="true" label="Do you currently have private health insurance cover?" fieldXpath="${fieldXpath}" id="${name}_primaryCover" className="lhcRebateCalcTrigger" helpId="${theHelpid}">
