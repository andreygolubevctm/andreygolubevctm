...
<c:if test="${item.isShortlistable()}">
    ...
    <c:choose>
        ...
        <c:otherwise>
            <c:set var="colWidthValue" value="categoriesCell_v2" />
        </c:otherwise>
    </c:choose>
        ...
        <div class="scrollable">
            ...
            <div class="${colWidthValue} short-list-item ${item.getClassString()} ${item.getShortlistKey()}_container">
                ...
                <div class="switch-container">
                    ...
                    <div id="tabs" class="benefitsTab_v2">
                        <p id="benefits_tab_extras_col_content">${colContent}</p>
                        <health_v4:benefits_switch_extras_message />
                        <health_v4_insuranceprefs_v2:quick_select
                                options="Dental:dental|Sports:sports|Peace of Mind:peace" trackingLabel="extras" />
                    </div>
                    <div class="extras-blank-space"></div>
                    <div id="selected-extras-count" class="cover-selected"></div>
                </c:if>
                <c:if test="${category eq 'Hospital'}">
                <div class="switch-container">
                <div class="title">
                    <h2 class="ignore bold">Private hospital cover</h2>
                </div>
                <div class="switchContainer">
                    <div class="switchContainerItem">
                ...
                <div id="tabs" class="benefitsTab_v2">
                    ...
                    <div id="selected-hospital-count" class="cover-selected"></div>
                    <div class="tab-content">
                                    ...
                                    <div class="hasIcons">
                                        <c:forEach items="${item.getChildren()}" var="selectedValue">
                                            <c:if test="${selectedValue.isShortlistable()}">
                                                ...
                                                <div class="categoriesCell_v2 ${colWidthValue} short-list-item ${selectedValue.getClassString()} ${selectedValue.getShortlistKey()}_container">
                                                    ...
                                                    <span class="benefit-label-container">
                                                    <span class="benefit-icon">
                                                        <label></label>
                                                    </span>
													<span class="benefitContent">
														<div class="benefitTitle_v2 needsclick">${selectedValue.getName()}</div>
                                                            <span class="benefitSummary_v2 needsclick">${benefitsContentBlurbs.getSupplementaryValueByKey(selectedValue.getId())}</span>
                                                            <div class="benefit-learn-more_v2">
                                                            <a href="javascript:;"
                        ...
                        <div class="tab-pane" id="limited-pane">
                            <div class="Extras-wrapper">
                                <div class="children healthBenefits">
                                    <div class="hasIcons">
                                        <div class="categoriesCell_v2 short-list-item category expandable collapsed HLTicon-limited_cover LimitedCover_container">
                                            <div class="checkbox">
                                                ...
                                                <label for="health_benefits_benefitsExtras_LimitedCover" data-analytics="benefit extras">
                                                    <span class="benefitContent">
                                                        <div class="benefitTitle_v2 needsclick">Limited Hospital Cover</div>
                                                        <span class="benefitSummary_v2 needsclick">accidental cover, avoid paying Medicare Levy Surcharge</span>
                                                    </span>
                                                </label>
                                            </div>
