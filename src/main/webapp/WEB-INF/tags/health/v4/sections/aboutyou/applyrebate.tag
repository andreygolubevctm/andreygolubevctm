...
<div class="form-group fieldrow">
	<div class="col-xs-12">
		...
		<div class="income_container hidden">
			...
			<field_v2:count_select xpath="${fieldXpath}" max="12" min="1" placeHolder="Please choose the number of dependents" title="number of dependants" required="true" hideElement="${true}" className="${name}_health_cover_dependants dependants" defaultValue="2" extraDataAttributes=" data-attach='true'" />
