...
<div class="${name}-selection">
    ...
    <form_v4:row fieldXpath="${fieldXpath}" label="What day would you like your payment deducted?"
    ...
    <form_v4:row fieldXpath="${fieldXpath}" label="What day would you like your payment deducted?" className="${name}-details_policyDay-group">
