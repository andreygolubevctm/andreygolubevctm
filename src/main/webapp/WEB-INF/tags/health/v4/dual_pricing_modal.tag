...
<core_v1:js_template id="dual-pricing-modal-template">
    ...
    <div class="row">
        <div class="col-xs-12 text-center">
            Health funds are adjusting their premiums on April 1st.  The amounts you see reflect the premiums <span class="text-bold">before</span> and <span class="text-bold">after</span> April 1st.
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-xs-12 text-center">
            <small>Alternatively, if you elect to pay your premium weekly, monthly, fortnightly, quarterly or half-yearly before {{= obj.dropDeadDate }}, <span class="text-bold">only payments made by April 1st will be at the current amount.</span> Thereafter the new premium will apply.</small>
        </div>
    </div>
