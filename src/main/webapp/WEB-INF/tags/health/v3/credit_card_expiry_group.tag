...
<form_v3:row label="Credit Card Expiry" isNestedStyleGroup="${true}">
    ...
    <form_v3:row fieldXpath="${fieldXpath}_cardExpiryMonth" label="Credit Card Expiry" id="${name}_expiry" className="health_credit-card-details_expiry_group" smRowOverride="12" isNestedField="${true}" hideHelpIconCol="${true}">
    ...
    <form_v3:row fieldXpath="${fieldXpath}" label="CCV number" helpId="402" className="health_credit-card-details_ccv" smRowOverride="7" isNestedField="${true}" hideHelpIconCol="${true}">
