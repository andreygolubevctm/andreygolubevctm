...
<%-- TEMPLATES --%>
	...
	<core_v1:js_template id="quoteref-template"><health_v4_results:quoteref_template /></core_v1:js_template>
	...
	<script id="confirmation-template" type="text/html">
		...
		{{ } }}
		<layout_v1:slide_columns colSize="9">

			<jsp:attribute name="rightColumn">
				<health_v3:policySummary showProductDetails="true" />
