...
<c:set var="logger" value="${go:getLogger('tag:health.provider_testing')}" />
...
${logger.debug('ENVIRONMENT={}', environmentService.getEnvironmentAsString())}
${logger.debug('remoteaddr={}', pageContext.request.remoteAddr)}
