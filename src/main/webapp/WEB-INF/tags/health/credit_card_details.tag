...
<div id="${name}-selection" class="health-credit_card_details">
	...
	<form_v2:fieldset legend="Credit Card Details">
		...
		<form_v2:row fieldXpath="${fieldXpath}" label="What day would you like your payment deducted?" className="health_credit-card-details_day_group">
		...
		<form_v2:row fieldXpath="${fieldXpath}" label="What day would you like your payment deducted?" className="health_credit-card-details_paymentDay_group">
