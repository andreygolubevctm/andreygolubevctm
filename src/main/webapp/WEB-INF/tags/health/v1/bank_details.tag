...
<div id="${name}-selection" class="health-bank_details">
	...
	<form_v2:fieldset legend="Bank Account Details" >
		...
		<form_v2:row fieldXpath="${fieldXpath}" label="What day would you like your payment deducted?" className="health_bank-details_day-group">
		...
		<form_v2:row fieldXpath="${fieldXpath}" label="What day would you like your payment deducted?" className="health_bank-details_paymentDay_group">
			<field_v1:payment_day xpath="${fieldXpath}" title="your chosen day" required="true"
								  className="health_payment_day health-bank_details-paymentDay"
								  messageClassName="health_payment-day_message"
								  displayDatePattern="dddd, D MMMM YYYY"
								  startOfMonth="true"
								  days="28"
		...
		<form_v2:row fieldXpath="${fieldXpath}" label="What day would you like your payment deducted?" className="health_bank-details_policyDay-group">
