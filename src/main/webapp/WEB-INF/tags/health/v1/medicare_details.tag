...
<div id="${name}-selection" class="health-medicare_details">
	...
	<simples:dialogue id="30" vertical="health" mandatory="true" />
		...
		<form_v3:row fieldXpath="${fieldXpath}" label="Are all people to be included on this policy covered by a green or blue Medicare card?" id="medicareCoveredRow" helpId="291" smRowOverride="5">
		...
		<form_v3:row label="Medicare card number and expiry" hideHelpIconCol="true" className="row" isNestedStyleGroup="${true}">
