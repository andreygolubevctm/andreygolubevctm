			...
			<div class="col-md-6 filter hidden">
				<div class="row">
					...
					<div id="filter-sort" data-filter-type="radio" class="col-sm-9">
						<field_v2:array_radio xpath="health/rank-by" title="Sort By" items="B=Benefits,L=Price" required="false" />
					</div>
				</div>
			</div>
				...
				<div class="col-md-6 filterLevelOfCover filter">
					<div class="row">
						...
						<div id="filter-tierHospital" data-filter-type="select" data-filter-serverside="true" class="col-xs-6 col-sm-4">
							<field_v2:array_select items="=Hospital level...,1=Public,2=Budget,3=Medium,4=Top" xpath="filters_tierHospital" title="" required="false" />
						</div>
						<div id="filter-tierExtras" data-filter-type="select" data-filter-serverside="true" class="col-xs-6 col-sm-4">
							<field_v2:array_select items="=Extras level...,1=Budget,2=Medium,3=Comprehensive" xpath="filters_tierExtras" title="" required="false" />
						</div>
					</div>
				</div>
				...
				<div class="col-md-8 filter">
					...
					<div class="row">
						<div class="col-sm-offset-3 col-sm-9 col-md-offset-2 col-md-10 notRestrictedBrands">
							<health_v1:filter_provider xpath="health/brandFilter" providersList="${providerList}"  fundType="notRestricted" />
						</div>
					</div>
				</div>
				<div class="col-md-4 filter">
					...
					<div class="row">
						<div class="col-sm-offset-3 col-sm-9 col-md-offset-4 col-md-8 col-lg-offset-3 col-lg-9 restrictedBrands">
							<health_v1:filter_provider xpath="health/brandFilter" providersList="${providerList}" fundType="restricted" />
						</div>
					</div>
				</div>
			</div>
