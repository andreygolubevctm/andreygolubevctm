...
<c:if test="${not isAltView}">
			...
			<div id="step2" class="accordion-collapse collapse">
				<div class="accordion-body">
					...
					<div class="row push-top-15">
						<div class="col-xs-12">
							<p class="detail-title">Business Activity</p>
							<ul>
							{{ if(businessActivity) { }}
		...
		<div class="panel accordion-panel col-xs-12 col-sm-6 col-lg-4 clear-lg-left">
			<div class="accordion-heading visible-xs">
				...
				<p class="accordion-title">
					<a class="needsclick" data-toggle="collapse" data-parent="#edit-details-panel-group" href="#step4"> 4. Previous Cover </a>
				</p>
			</div>
		...
		<div class="panel accordion-panel col-xs-12 col-sm-6 col-lg-4">
			<div class="accordion-heading visible-xs">
				...
				<p class="accordion-title">
					<a class="needsclick" data-toggle="collapse" data-parent="#edit-details-panel-group" href="#step5"> 5. Policy Holders </a>
				</p>
			</div>
				...
				<div class="accordion-body">
					...
					<div class="row">
						...
						<div class="col-xs-12 col-sm-6">
							...
							<ul>
								<li><span data-source="#home_policyHolder_jointTitle"></span> <span data-source="#home_policyHolder_jointFirstName"></span> <span data-source="#home_policyHolder_jointLastName"></span></li>
								<li><span data-source="#home_policyHolder_jointDob"></span></li>
							</ul>
						</div>
					</div>
					{{ if(hasOlderResident) { }}
