...
<form_v2:fieldset legend="Electricity" className="electricity-details">
    ...
    <form_v2:row label="Do you have solar panels installed on your property?" fieldXpath="${fieldXPath}" className="clear">
    ...
    <form_v2:row label="Select the level that best describes your typical electricity usage" fieldXpath="${fieldXPath}" className="clear electricity-usage">
        <field_new:array_radio xpath="${fieldXPath}"
                               required="true"
                               className="col-md-12"
    ...
    <form_v2:row label="How much is your bill?" className="clear additional-estimate-details-row spend">
    ...
    <form_v2:row label="How many days are in the billing period?" className="clear additional-estimate-details-row days">
        <utilities_new_fieldset:additional_estimate_details_input xpath="${xpath}"
                                                                  utilityType="Electricity"
                                                                  inputType="days"
                                                                  required="true"
    ...
    <form_v2:row label="How are you charged for electricity?" fieldXpath="${fieldXPath}" className="clear additional-estimate-details-row electricity-meter">
        <field_new:array_radio xpath="${fieldXPath}"
                               required="true"
                               className=""
    ...
    <form_v2:row label="Standard usage" className="clear usage standard-usage">
    <utilities_new_fieldset:additional_estimate_details_input xpath="${xpath}"
                                                              utilityType="Electricity"
                                                              inputType="peak"
                                                              helpId="536"
    ...
    <form_v2:row label="Peak usage" className="clear usage peak-usage">
        <utilities_new_fieldset:additional_estimate_details_input xpath="${xpath}"
                                                                  utilityType="Electricity"
                                                                  inputType="peak"
                                                                  required="true"
    ...
    <form_v2:row label="Off-peak usage (if any)" className="clear usage off-peak-usage">
        <utilities_new_fieldset:additional_estimate_details_input xpath="${xpath}"
                                                                  utilityType="Electricity"
                                                                  inputType="offpeak"
                                                                  required="true"
    ...
    <form_v2:row label="Controlled Load" className="clear usage controlled-usage">
    <utilities_new_fieldset:additional_estimate_details_input xpath="${xpath}"
                                                              utilityType="Electricity"
                                                              inputType="offpeak"
                                                              required="false"
    ...
    <form_v2:row label="Shoulder usage (if any)" className="clear usage shoulder-usage">
        <utilities_new_fieldset:additional_estimate_details_input xpath="${xpath}"
                                                                  utilityType="Electricity"
                                                                  inputType="shoulder"
                                                                  required="false"
...
<form_v2:fieldset legend="Gas" className="gas-details">
    ...
    <form_v2:row label="Select the level that best describes your typical gas usage" fieldXpath="${fieldXPath}" className="clear gas-usage">
        <field_new:array_radio xpath="${fieldXPath}"
                               required="true"
                               className="col-md-12"
    ...
    <form_v2:row label="How much do you usually spend?" className="clear additional-estimate-details-row spend">
        <utilities_new_fieldset:additional_estimate_details_input xpath="${xpath}"
                                                                  utilityType="Gas"
                                                                  inputType="spend"
                                                                  required="true"
    ...
    <form_v2:row label="Standard usage (peak/anytime)" className="clear additional-estimate-details-row usage">
        <utilities_new_fieldset:additional_estimate_details_input xpath="${xpath}"
                                                                  utilityType="Gas"
                                                                  inputType="peak"
                                                                  helpId="538"
    ...
    <form_v2:row label="Off-peak usage (if any)" className="clear additional-estimate-details-row usage">
