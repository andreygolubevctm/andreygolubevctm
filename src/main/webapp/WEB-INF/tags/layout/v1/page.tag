					...
					<c:if test="${pageSettings.getVerticalCode() eq 'travel'}">
						<div class="row navbar-mobile coverLevelTabs visible-xs hidden-sm hidden-md hidden-lg">
									...
									<div class="dropdown-menu dropdown-menu-more-filters" aria-labelledby="moreFiltersDropdownBtn">
										...
										<div class="row">
											...
											<div class="col-xs-12 col-sm-7 text-left filter-section">
												...
												<div class="row visible-xs hidden-sm hidden-md hidden-lg">
													<div class="col-xs-6">
														<span class="filter-brands-toggle">
															<b>Filter brands</b> <i class="icon icon-angle-down"></i>
														</span>
													</div>
												...
												<span class="filter-brands-container hide">
							...
							<div class="col-xs-4 clt-trip-filter">
								<div class="col-xs-12 col-md-5 text-left hidden-xs"><b>Excess</b></div>
