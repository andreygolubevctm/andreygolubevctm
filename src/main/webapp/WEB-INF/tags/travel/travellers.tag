...
<div class="form-group row fieldrow smallWidth">
  ...
  <div class="col-sm-5 col-xs-12 age-container">
    <div class="age-item col-md-5 col-lg-3">
      ...
      <div class="clearfix">
        <input data-msg-required="Please add age" data-msg-range="Age must be between 10-99" data-rule-range="10,99" name="travellers-age-1" required type="number" maxlength="2" />
      </div>
    </div>
  </div>
