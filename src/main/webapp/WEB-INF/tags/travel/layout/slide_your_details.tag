		...
		<jsp:body>
			<layout_v1:slide_content>
                ...
                <form_v2:fieldset legend="Duration" className="travel_maxDuration" id="amtDurationsfs">
                    <form_v2:row label="What is the maximum number of days you will be away from home for any single journey?" className="smallWidth" smRowOverride="1">
                        <field_v2:array_radio items="15=15 days,30=30 days,45=45 days,60=60 days,90=90 days" xpath="travel/amtDuration" title="max trip duration" required="true" className="radio travel-radio-btn" style="radio-green" />
                    </form_v2:row>
                </form_v2:fieldset>
