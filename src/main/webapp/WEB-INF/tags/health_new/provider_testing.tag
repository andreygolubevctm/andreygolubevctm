				...
				<form_new_layout:fieldset_columns>
					...
					<jsp:body>
						<form_new:fieldset legend="Provider Testing">
							...
							<form_new_layout:row label="Provider" fieldXpath="${fieldXpath}">
								<field:provider_select productCategories="HEALTH" xpath="${fieldXpath}" />
							</form_new_layout:row>
							<form_new_layout:row label="ProductName" fieldXpath="${xpath}/productTitleSearch">
							...
							<form_new_layout:row label="Number of results" fieldXpath="${fieldXpath}">
	...
	<form_new_layout:fieldset_columns>
		...
		<jsp:body>
			<form_new:fieldset legend="">
				...
				<form_new_layout:row label="Application/Cover Date" fieldXpath="${fieldXpath}">
