...
<div id="${name}-selection" class="health-medicare_details">
	...
	<form_new:fieldset legend="Medicare Details" id="medicare_details" className="medicare_details">
		...
		<form_new_layout:row fieldXpath="${fieldXpath}" label="Are all people to be included on this policy covered by a green or blue Medicare card?" id="medicareCoveredRow" helpId="291">
		...
		<form_new_layout:row fieldXpath="${fieldXpath}" label="Your Medicare Card Number">
		...
		<form_new_layout:row fieldXpath="${fieldXpath}" label="Medicare Expiry Date">
		...
		<form_new_layout:row fieldXpath="${fieldXpath}" label="First Name on Medicare card">
		...
		<form_new_layout:row fieldXpath="${fieldXpath}" label="Middle Initial on Medicare card">
		...
		<form_new_layout:row fieldXpath="${fieldXpath}" label="Last Name on Medicare card">
		...
		<form_new_layout:row fieldXpath="${fieldXpath}" label="Position you appear on your medicare card"  className="health_payment_medicare_cardPosition-group">
