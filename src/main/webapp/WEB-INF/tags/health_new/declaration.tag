...
<div id="${name}-selection" class="health_declaration">
	...
	<form_new_layout:row fieldXpath="${fieldXpath}" label="Australian Government Rebate Form" className="ausgovtrebateform" hideHelpIconCol="true">
	...
	<form_new_layout:row fieldXpath="${fieldXpath}" label='Join Declaration for <span>Provider</span>' hideHelpIconCol="true">
