...
<div id="${name}-selection" class="health_application-details">
	...
	<form_new:fieldset legend="Contact Details">
		...
		<group_new_layout:address xpath="${xpath}/address" type="R" stateValidationField="#health_application-selection .content"/>
		...
		<div id="${name}_postalGroup">
			<group_new_layout:address xpath="${xpath}/postal" type="P" stateValidationField="#health_application-selection .content"/>
		</div>

		<group_new_layout:contact_numbers xpath="${xpath}" required="true" />

		<c:set var="fieldXpath" value="${xpath}/email" />
		<form_new_layout:row fieldXpath="${fieldXpath}" label="Email Address" id="${name}_emailGroup">
		...
		<form_new_layout:row fieldXpath="${fieldXpath}" id="${name}_noEmailGroup">
		...
		<form_new_layout:row id="${name}_optInEmail-group" hideHelpIconCol="true">
		...
		<form_new_layout:row id="${name}_okToCall-group" hideHelpIconCol="true">
		...
		<form_new_layout:row fieldXpath="${fieldXpath}" label="How would you like <span>the Fund</span> to send you information?" id="${name}_contactPoint-group"
