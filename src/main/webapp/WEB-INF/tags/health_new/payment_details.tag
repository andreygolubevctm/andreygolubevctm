...
<div id="${name}-selection" class="health-payment_details">
	...
	<form_new:fieldset legend="Payment Details" >
		...
		<form_new_layout:row fieldXpath="${fieldXpath}" label="How often would you like to make payments" className="changes-premium">
		...
		<form_new_layout:row fieldXpath="${fieldXpath}" label="Do you want to supply bank account details for claims to be paid into" className="health-payment_details-claims-group">
		...
		<c:if test="${not empty disclaimer_content}">
			...
			<form_new_layout:row fieldXpath="${fieldXpath}" hideHelpIconCol="true">
		...
		<form_new_layout:row className="health-payment-details_update" hideHelpIconCol="true">
		...
		<form_new_layout:row label="Your Premium" className="health-payment-details_premium">
