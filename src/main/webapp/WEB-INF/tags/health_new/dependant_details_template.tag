...
<core:js_template id="health-dependants-template">
    ...
    <div id="${name}" class="health_dependant_details dependant{{= obj.dependantId }}" data-id="{{= obj.dependantId }}">
        ...
        <div class="items">
            ...
            <form_new_layout:row fieldXpath="${fieldXpath}" label="Title">
            ...
            <form_new_layout:row fieldXpath="${fieldXpath}" label="First Name">
            ...
            <form_new_layout:row fieldXpath="${fieldXpath}" label="Middle Name" className="health_dependant_details_middleName">
            ...
            <form_new_layout:row fieldXpath="${fieldXpath}" label="Last Name">
            ...
            <form_new_layout:row fieldXpath="${fieldXpath}" label="Date of Birth">
            ...
            <form_new_layout:row fieldXpath="${fieldXpath}" label="Full-time student" id="${name}_fulltimeGroup"
            ...
            <form_new_layout:row fieldXpath="${fieldXpath}" label="{{= (usesSchoolDropdown ? 'Educational institute this dependant is attending' : 'Name of school your child is attending') }}" id="${name}_schoolGroup"
            ...
            <form_new_layout:row fieldXpath="${fieldXpath}" label="Student ID Number" id="${name}_schoolIDGroup"
            ...
            <form_new_layout:row fieldXpath="${fieldXpath}" label="Date Study Commenced" id="${name}_schoolDateGroup"
            ...
            <form_new_layout:row fieldXpath="${fieldXpath}"
