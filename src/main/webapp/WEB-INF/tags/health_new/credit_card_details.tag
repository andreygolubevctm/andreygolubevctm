...
<div id="${name}-selection" class="health-credit_card_details">
	...
	<form_new:fieldset legend="Credit Card Details">
		...
		<form_new_layout:row fieldXpath="${fieldXpath}" label="Credit Card Type" className="health_credit-card_details_type_group">
		...
		<form_new_layout:row fieldXpath="${fieldXpath}" label="Name on Credit Card" className="health_credit-card-details_name">
		...
		<form_new_layout:row fieldXpath="${fieldXpath}" label="Credit Card Number" className="health_credit-card-details_number_group">
		...
		<form_new_layout:row fieldXpath="${fieldXpath}_cardExpiryMonth" label="Credit Card Expiry" id="${name}_expiry" className="health_credit-card-details_expiry_group">
		...
		<form_new_layout:row fieldXpath="${fieldXpath}" label="CCV number" helpId="402" className="health_credit-card-details_ccv">
		...
		<form_new_layout:row fieldXpath="${fieldXpath}" label="What day would you like your payment deducted?" className="health_credit-card-details_day_group">
		...
		<form_new_layout:row fieldXpath="${fieldXpath}" label="What day would you like your payment deducted?" className="health_credit-card-details_paymentDay_group">
		...
		<form_new_layout:row fieldXpath="${fieldXpath}" label="What day would you like your payment deducted?" className="health_credit-card-details_policyDay-group">
