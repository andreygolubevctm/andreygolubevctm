...
<div id="${name}">
	...
	<form_new:fieldset id="${id}" legend="Previous Fund Details" className="health-previous_fund">
		...
		<form_new_layout:row fieldXpath="${fieldXpath}" label="Your Current Health Fund" id="clientFund" className="changes-premium">
		...
		<div id="clientMemberID" class="membership">
			...
			<form_new_layout:row fieldXpath="${fieldXpath}" label="Membership Number" className="clientMemberID">
			...
			<form_new_layout:row fieldXpath="${fieldXpath}" className="health_previous_fund_authority hidden" helpId="522">
		...
		<form_new_layout:row fieldXpath="${fieldXpath}" label="Partner's Current Health Fund" id="partnerFund" className="changes-premium">
		...
		<div id="partnerMemberID" class="membership">
			...
			<form_new_layout:row fieldXpath="${fieldXpath}" label="Membership Number" className="partnerMemberID">
