...
<div class="health-person-details-${id} health-person-details ${id}">
	...
	<form_new:fieldset legend="${title} Details">
		...
		<form_new_layout:row fieldXpath="${fieldXpath}" label="Middle Name" className="health_person-details_middlename">
		...
		<form_new_layout:row fieldXpath="${fieldXpath}" label="Date of Birth" className="changes-premium">
		...
		<form_new_layout:row fieldXpath="${fieldXpath}" label="Gender" id="${name}_genderRow">
		...
		<c:if test="${id == 'partner'}">
			...
			<form_new_layout:row fieldXpath="${fieldXpath}" label="Would you like to give your partner authority to make claims, changes or enquire about the policy on behalf of anyone listed on the policy?" id="${name}_authority_group" className="health_person-details_authority_group hidden">
