...
<form_v4:row label="Mobile Number" id="${fieldXpath}input" smRowOverride="3">
    <field_v1:flexi_contact_number xpath="${fieldXPath}"
                                   maxLength="20"
                                   required="false"
                                   className="sessioncamexclude data-hj-suppress"
...
<form_v4:row label="Other Number" id="${fieldXpath}input" smRowOverride="3">
    <field_v1:flexi_contact_number xpath="${fieldXPath}"
                                   maxLength="20"
                                   required="false"
                                   className="sessioncamexclude data-hj-suppress"
