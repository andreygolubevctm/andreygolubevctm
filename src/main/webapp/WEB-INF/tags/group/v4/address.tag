...
<form_v4:row fieldXpath="${fieldXpath}" label="Postcode" id="${name}_postCode_suburb" smRowOverride="5">
    <field_v1:post_code xpath="${fieldXpath}" required="true" title="postcode" additionalAttributes=" data-rule-validAddress='${name}' data-msg-validAddress='Please enter a valid postcode' data-validation-position='append'" disableErrorContainer="${false}" />
</form_v4:row>
<core_v1:clear />
...
<div class="${name}_non_standard_container">
    ...
    <form_v4:row fieldXpath="${fieldXpath}" label="Unit/Shop/Level" id="${name}_unitShopRow" className="std_streetUnitShop ${name}_unitShopRow" smRowOverride="5">
...
<div class="${name}_non_standard_container">
    ...
    <form_v4:row fieldXpath="${fieldXpath}" label="Suburb" className="${name}_nonStd_street" smRowOverride="5">
        <c:choose>
