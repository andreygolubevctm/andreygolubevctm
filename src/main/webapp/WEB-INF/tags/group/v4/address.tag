...
<form_v4:row label="Postcode" isNestedStyleGroup="${true}">
    ...
    <form_v4:row fieldXpath="${fieldXpath}" label="Suburb" className="${name}_nonStd_street" smRowOverride="7" isNestedField="${true}">
        <c:choose>
...
<form_v4:row label="Unit / Street Number" isNestedStyleGroup="${true}" className="${name}_non_standard_container">
    <%-- UNIT/SHOP (BOTH STD & NON STD) --%>
    <c:set var="fieldXpath" value="${xpath}/unitShop" />
    <form_v4:row fieldXpath="${fieldXpath}" label="Unit/Shop/Level" id="${name}_unitShopRow" className="std_streetUnitShop ${name}_unitShopRow" smRowOverride="5" isNestedField="${true}">
    ...
    <form_v4:row fieldXpath="${fieldXpath}" label="${streetLabel}" id="${name}_streetNumRow" className="std_streetNum" smRowOverride="2"  isNestedField="${true}">
    ...
    <form_v4:row fieldXpath="${fieldXpath}" label="Unit Type" className="${name}_nonStd_street ${name}_unitShopRow" smRowOverride="5"  isNestedField="${true}">
...
<form_v4:row fieldXpath="${fieldXpath}" label="" id="${name}_nonStd_row" className="nonStd">
