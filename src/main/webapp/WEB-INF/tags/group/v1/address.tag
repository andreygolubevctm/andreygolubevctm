...
<form_v1:row label="Suburb" className="halfrow right ${name}_nonStd_street" >
	<c:choose>
...
<form_v1:row label="${addressLabel}" id="${name}_std_street" className="std_street">
...
<form_v1:row label="Street" className="${name}_nonStd_street">
...
<form_v1:row label="Unit/Shop/Level" id="${name}_unitShopRow" className="std_streetUnitShop halfrow ${name}_unitShopRow">
...
<form_v1:row label="" id="${name}_nonStd_row" className="nonStd">
