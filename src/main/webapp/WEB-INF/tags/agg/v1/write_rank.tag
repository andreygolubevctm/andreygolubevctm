...
<c:if test="${empty transactionId}">
	...
	${fatalErrorService.logFatalErrorTransactionIdString(0,  pageSettings.getBrandId(), pageContext.request.servletPath , pageContext.session.id, false, transactionId)}
