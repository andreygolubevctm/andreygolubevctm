...
<c:if test="${octoberComp}">
  <div class="octoberComp">
    <div class="octoberComp__mobile">
      ...
      <p>Buy ${vertical} insurance for your chance to win a share of $81,000. <a target="_blank" href="https://www.comparethemarket.com.au/competition/october_promotion_2017.pdf
">T&C's apply.</a></p>
