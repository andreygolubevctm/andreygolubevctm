...
<core_v1:js_template id="brands-template">
	...
	<c:set var="brands"
		value="${fn:split('ADLB,AFG,AMP,ANZ,AUSWIDE,BANKAUST,BOC,BOM,BOS,BANKSA,BANKWEST,BEYOND,BLUESTONE,BOQ,CBA,CITI,FIREFIGHTERS,HERITAGE,HOMESTART,ING,KEY,LATROBE,LIBERTY,MACQ,ME,MKM,MYSTATE,NAB,NABBROKER,NEWCASTLE,PN,PEPPER,QBANK,GEORGE,SUNCORP,TMB,UNIBANK,WESTPAC,VIRG,HOMELOANS,IMB,',',')}" />
