...
<c:catch var="error">
    ...
    <c:set var="unsubscribe"
           value="${unsubscribeService.getUnsubscribeDetails(param.vertical, brandId, fn:substring(param.unsubscribe_email, 0, 256), param.email, false, pageSettings, pageContext.getRequest(), param.token)}"
           scope="session"/>
