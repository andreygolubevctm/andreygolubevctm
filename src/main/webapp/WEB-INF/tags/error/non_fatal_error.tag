...
<c:set var="logger" value="${go:getLogger('tag:error.non_fatal_error')}" />
...
{logger.warn('property={} origin={} errorMessage={} errorCode={} transactionId={}', property, origin, errorMessage, errorCode, transactionId)}
