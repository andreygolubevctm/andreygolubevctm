...
var Compare = function( _config ) {
	...
	var appendCompareList = function(type, product_id) {
		...
		elements.finish.css({backgroundImage:"url(assets/graphics/logos/life/44x25/" + list[type][product_id].thumb + "?v=2)"});
		...
		*/
		...
		for( var j = 0; j < data.length; j++ ) {
			...
			var info = {
				...
				logo :	"assets/graphics/logos/life/83x53/" + prod.thumb + "?v=2",
