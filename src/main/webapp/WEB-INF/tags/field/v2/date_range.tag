...
<%-- HTML --%>
<form_v2:row label="${labelFrom}" helpId="${helpIdFrom}" id="${fromDate}_row">
	<field_v2:calendar mode="separated" validateMinMax="true" xpath="${fromDateXpath}" required="${required}" title="${titleFrom}" minDate="${minDateFrom}" maxDate="${maxDateFrom}" startView="${startViewFrom}" calAdditionalAttributes="${fromDateRule}" />
</form_v2:row>
<form_v2:row label="${labelTo}" helpId="${helpIdTo}" id="${toDate}_row">
	<field_v2:calendar mode="separated" validateMinMax="true" xpath="${toDateXpath}" required="${required}" title="${titleTo}" minDate="${minDateTo}" maxDate="${maxDateTo}" startView="${startViewTo}"  calAdditionalAttributes="${toDateRule}"/>
</form_v2:row>