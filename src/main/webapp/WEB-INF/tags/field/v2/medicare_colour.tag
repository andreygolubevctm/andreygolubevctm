...
<div class="select">
    ...
    <field_v1:array_select xpath="${xpath}" items="=Please Choose...,green=Green,blue=Blue,yellow=Yellow,none=None of the above" className="dontSubmit" required="true" title="your Medicare card colour. To proceed with this policy, you must have a green, blue or yellow medicare card." />
</div>