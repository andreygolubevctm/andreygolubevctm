...
<c:set var="unitTypes">=Enter Postcode</c:set>
...
<div class="addressSearchV2 addressSearchV2--street">
  ...
  <form_v2:row label="Street Search" className="addressSearchV2__searchContainer">
    <field_v2:input className="addressSearchV2__input" xpath="${xpath}/fullAddressLineOne" required="true" title="postcode" additionalAttributes=" data-rule-validAddress='${name}' data-msg-validAddress='Please enter a valid postcode' data-validation-position='append'" disableErrorContainer="${false}" />
    <div class="addressSearchV2__results"></div>
  </form_v2:row>
  <field_v1:hidden xpath="streetName" />
  <field_v1:hidden xpath="state" />
  ...
  <div class="addressSearchV2__cantFindFields addressSearchV2__cantFindFields--hidden">
    ...
    <form_v2:row fieldXpath="${xpath}" label="Suburb" className="addressSearchV2__suburbSelect">
      <field_v2:array_select items="${unitTypes}" xpath="${xpath}/suburb" title="the unit type" required="true" includeInForm="true"  placeHolder="Enter Postcode" extraDataAttributes="data-validation-position='append'" />
    </form_v2:row>
    ...
    <form_v2:row fieldXpath="${xpath}" label="Unit Type">
      <field_v2:array_select items="${unitTypes}" xpath="${xpath}" title="the unit type" required="false" includeInForm="true" placeHolder="Unit Type" extraDataAttributes="data-validation-position='append'" />
    </form_v2:row>
