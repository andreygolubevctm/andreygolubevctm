    ...
    <layout_v1:slide_columns>
        ...
        <jsp:body>
            <layout_v1:slide_content>
                <utilities_v2_fieldset:household_details xpath="${xpath}/householdDetails" />
                <utilities_v2_fieldset:additional_estimate_details xpath="${xpath}/estimateDetails" />
