...
<form_v2:fieldset legend="Preferences" className="preferences" postLegend="Show results that match to your chosen preferences only. Choose your 'must-haves' below.">
    <div class="has-icons">
        <form_v3:row label="" className="account-fees-container">
            <field_v2:checkbox xpath="${xpath}/preferNoContract"  value="Y" title="<span><br>No lock in contracts or exit fees</span>" required="false" label="true"  />
        </form_v3:row>
        ...
        <form_v3:row label="" className="renewable-energy-container">
            <field_v2:checkbox xpath="${xpath}/preferRenewableEnergy" value="Y" title="<span><br>Green or renewable energy plans</span>" required="false" label="true"  />
        </form_v3:row>
    </div>
</form_v2:fieldset>
