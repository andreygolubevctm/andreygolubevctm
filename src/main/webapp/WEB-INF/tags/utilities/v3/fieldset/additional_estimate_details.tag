...
<form_v2:fieldset legend="Electricity" className="electricity-details">
    ...
    <form_v3:row label="Select the level that best describes your typical electricity usage" fieldXpath="${fieldXPath}" className="clear electricity-usage">
        <field_v2:array_radio xpath="${fieldXPath}"
                               required="true"
                               className="col-md-12"
...
<form_v2:fieldset legend="Gas" className="gas-details">
    ...
    <form_v3:row label="Select the level that best describes your typical gas usage" fieldXpath="${fieldXPath}" className="clear gas-usage">
        <field_v2:array_radio xpath="${fieldXPath}"
                               required="true"
                               className="col-md-12"
