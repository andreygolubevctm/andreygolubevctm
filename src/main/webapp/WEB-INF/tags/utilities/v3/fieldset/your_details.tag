...
<form_v2:fieldset legend="Your Details">
    ...
    <form_v3:row label="Title" fieldXpath="${fieldXPath}" className="clear">
    ...
    <form_v3:row label="Last name" fieldXpath="${fieldXPath}" className="clear">
        <field_v1:person_name xpath="${fieldXPath}" required="true" title="Last Name"/>
    </form_v3:row>

    <c:set var="fieldXPath" value="${xpath}/dob" />
    <form_v3:row label="Date of birth" fieldXpath="${fieldXPath}" className="clear date-of-birth">
    ...
    <form_v3:row label="Email address" fieldXpath="${fieldXPath}" className="clear">
        <field_v2:email xpath="${fieldXPath}" required="true" />
    </form_v3:row>

    <c:set var="fieldXPath" value="${xpath}/receiveInfoCheck" />
    <form_v3:row label="" fieldXpath="${fieldXPath}" id="receiveInfoCheckContainer" className="clear">
    ...
    <form_v3:row label="Move in date" fieldXpath="${fieldXPath}" id="enquiry_move_in_date_container" className="clear">
