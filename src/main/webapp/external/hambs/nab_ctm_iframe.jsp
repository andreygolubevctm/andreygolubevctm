...
<c:if test="${not empty param.providerCode}">
	...
	<c:set var="config" value="${configResolver.getConfig(pageContext.request.servletContext, '/WEB-INF/aggregator/health_application/${param.providerCode}/config.xml')}" />
