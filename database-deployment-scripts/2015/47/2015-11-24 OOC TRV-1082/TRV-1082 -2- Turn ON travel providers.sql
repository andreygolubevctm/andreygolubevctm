...
UPDATE ctm.stylecode_provider_exclusions SET excludeDateTo='2015-11-23 23:59:59' WHERE providerId IN (@cov,@ski,@und,@kan,@trk) AND CURRENT_DATE BETWEEN excludeDateFrom AND excludeDateTo;
