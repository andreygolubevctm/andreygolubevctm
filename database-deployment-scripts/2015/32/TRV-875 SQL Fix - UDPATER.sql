...
INSERT INTO ctm.travel_product_benefits (id,providerId,productId,benefitId,label,description,benefitValue,benefitValueText,overrideExternal,startDate,endDate) VALUES
	...
	(null,44,@FOW_ESSE,@DEATH,@COPY,@COPY,0,'Nil',0,@START_DATE,@END_DATE),
	(null,44,@FOW_COMP,@DEATH,@COPY,@COPY,20000,'$20,000',0,@START_DATE,@END_DATE),
	(null,44,@FOW_LAST,@DEATH,@COPY,@COPY,0,'Nil',0,@START_DATE,@END_DATE),
...
INSERT INTO ctm.travel_product_benefits (id,providerId,productId,benefitId,label,description,benefitValue,benefitValueText,overrideExternal,startDate,endDate) VALUES 
	...
	(null,44,@FOW_LAST,@TRANSPORT,@COPY,@COPY,0,'Nil',0,@START_DATE,@END_DATE),
...
INSERT INTO ctm.travel_product_benefits (id,providerId,productId,benefitId,label,description,benefitValue,benefitValueText,overrideExternal,startDate,endDate) VALUES 
	...
	(null,44,@FOW_LAST,@CDXHOLIDAYFEE,@COPY,@COPY,0,'Nil',0,@START_DATE,@END_DATE),
...
INSERT INTO ctm.travel_product_benefits (id,providerId,productId,benefitId,label,description,benefitValue,benefitValueText,overrideExternal,startDate,endDate) VALUES 
	...
	(null,44,@FOW_LAST,@LUGGAGE_DELAY,@COPY,@COPY,0,'Nil',0,@START_DATE,@END_DATE),
...
INSERT INTO ctm.travel_product_benefits (id,providerId,productId,benefitId,label,description,benefitValue,benefitValueText,overrideExternal,startDate,endDate) VALUES 
	...
	(null,44,@FOW_DOME,@DENTAL,@COPY,@COPY,0,'Nil',0,@START_DATE,@END_DATE),
...
INSERT INTO ctm.travel_product_benefits (id,providerId,productId,benefitId,label,description,benefitValue,benefitValueText,overrideExternal,startDate,endDate) VALUES 
	...
	(null,54,@FOW_DOME,@HIJACK_KIDNAP,@COPY,@COPY,0,'Nil',0,@START_DATE,@END_DATE),
	(null,54,@FOW_ESSE,@HIJACK_KIDNAP,@COPY,@COPY,0,'Nil',0,@START_DATE,@END_DATE),
	(null,44,@FOW_COMP,@HIJACK_KIDNAP,@COPY,@COPY,1500,'$1,500',0,@START_DATE,@END_DATE),
	(null,44,@FOW_LAST,@HIJACK_KIDNAP,@COPY,@COPY,0,'Nil',0,@START_DATE,@END_DATE),
...
INSERT INTO ctm.travel_product_benefits (id,providerId,productId,benefitId,label,description,benefitValue,benefitValueText,overrideExternal,startDate,endDate) VALUES 
	...
	(null,44,@FOW_DOME,@HOSPITAL_CASH,@COPY,@COPY,0,'Nil',0,@START_DATE,@END_DATE),
	...
	(null,44,@FOW_LAST,@HOSPITAL_CASH,@COPY,@COPY,0,'Nil',0,@START_DATE,@END_DATE),
...
INSERT INTO ctm.travel_product_benefits (id,providerId,productId,benefitId,label,description,benefitValue,benefitValueText,overrideExternal,startDate,endDate) VALUES 
	...
	(null,44,@FOW_DOME,@INCOME_LOSS,@COPY,@COPY,0,'Nil',0,@START_DATE,@END_DATE),
	(null,44,@FOW_ESSE,@INCOME_LOSS,@COPY,@COPY,0,'Nil',0,@START_DATE,@END_DATE),
	(null,44,@FOW_COMP,@INCOME_LOSS,@COPY,@COPY,10400,'$10,400',0,@START_DATE,@END_DATE),
	(null,44,@FOW_LAST,@INCOME_LOSS,@COPY,@COPY,0,'Nil',0,@START_DATE,@END_DATE),
...
INSERT INTO ctm.travel_product_benefits (id,providerId,productId,benefitId,label,description,benefitValue,benefitValueText,overrideExternal,startDate,endDate) VALUES 
	...
	(null,44,@FOW_DOME,@MEDICAL_ASSI,@COPY,@COPY,0,'Nil',0,@START_DATE,@END_DATE),
...
INSERT INTO ctm.travel_product_benefits (id,providerId,productId,benefitId,label,description,benefitValue,benefitValueText,overrideExternal,startDate,endDate) VALUES 
	...
	(null,44,@FOW_LAST,@DISABILITY,@COPY,@COPY,0,'Nil',0,@START_DATE,@END_DATE),
...
INSERT INTO ctm.travel_product_benefits (id,providerId,productId,benefitId,label,description,benefitValue,benefitValueText,overrideExternal,startDate,endDate) VALUES 
	...
	(null,44,@FOW_DOME,@DOMESTIC_PETS,@COPY,@COPY,0,'Nil',0,@START_DATE,@END_DATE),
	(null,44,@FOW_ESSE,@DOMESTIC_PETS,@COPY,@COPY,0,'Nil',0,@START_DATE,@END_DATE),
	(null,44,@FOW_COMP,@DOMESTIC_PETS,@COPY,@COPY,500,'$500',0,@START_DATE,@END_DATE),
	(null,44,@FOW_LAST,@DOMESTIC_PETS,@COPY,@COPY,0,'Nil',0,@START_DATE,@END_DATE),
	(null,44,@FOW_AMT,@DOMESTIC_PETS,@COPY,@COPY,500,'$500',0,@START_DATE,@END_DATE);
...
INSERT INTO ctm.travel_product_benefits (id,providerId,productId,benefitId,label,description,benefitValue,benefitValueText,overrideExternal,startDate,endDate) VALUES 
	...
	(null,44,@FOW_DOME,@JOURNEY_RESUMPTION,@COPY,@COPY,0,'Nil',0,@START_DATE,@END_DATE),
	(null,44,@FOW_ESSE,@JOURNEY_RESUMPTION,@COPY,@COPY,0,'Nil',0,@START_DATE,@END_DATE),
	(null,44,@FOW_COMP,@JOURNEY_RESUMPTION,@COPY,@COPY,3000,'$3,000',0,@START_DATE,@END_DATE),
	(null,44,@FOW_LAST,@JOURNEY_RESUMPTION,@COPY,@COPY,0,'Nil',0,@START_DATE,@END_DATE),
	(null,44,@FOW_AMT,@JOURNEY_RESUMPTION,@COPY,@COPY,3000,'$3,000',0,@START_DATE,@END_DATE);
SET @CASH_THEFT = (SELECT benefitId FROM ctm.travel_benefit_master WHERE benefitName='CASH_THEFT');
...
INSERT INTO ctm.travel_product_benefits (id,providerId,productId,benefitId,label,description,benefitValue,benefitValueText,overrideExternal,startDate,endDate) VALUES 
	...
	(null,44,@FOW_DOME,@CASH_THEFT,@COPY,@COPY,250,'$250',0,@START_DATE,@END_DATE),
	(null,44,@FOW_ESSE,@CASH_THEFT,@COPY,@COPY,250,'$250',0,@START_DATE,@END_DATE),
	(null,44,@FOW_COMP,@CASH_THEFT,@COPY,@COPY,400,'$400',0,@START_DATE,@END_DATE),
	(null,44,@FOW_LAST,@CASH_THEFT,@COPY,@COPY,0,'Nil',0,@START_DATE,@END_DATE),
	(null,44,@FOW_AMT,@CASH_THEFT,@COPY,@COPY,400,'$400',0,@START_DATE,@END_DATE);
SET @TRAVEL_DELAY_EXP = (SELECT benefitId FROM ctm.travel_benefit_master WHERE benefitName='TRAVEL_DELAY_EXP');
...
INSERT INTO ctm.travel_product_benefits (id,providerId,productId,benefitId,label,description,benefitValue,benefitValueText,overrideExternal,startDate,endDate) VALUES 
	...
	(null,44,@FOW_DOME,@TRAVEL_DELAY_EXP,@COPY,@COPY,1000,'$1,000',0,@START_DATE,@END_DATE),
	(null,44,@FOW_ESSE,@TRAVEL_DELAY_EXP,@COPY,@COPY,1000,'$1,000',0,@START_DATE,@END_DATE),
	(null,44,@FOW_COMP,@TRAVEL_DELAY_EXP,@COPY,@COPY,2000,'$2,000',0,@START_DATE,@END_DATE),
	(null,44,@FOW_LAST,@TRAVEL_DELAY_EXP,@COPY,@COPY,0,'Nil',0,@START_DATE,@END_DATE),
	(null,44,@FOW_AMT,@TRAVEL_DELAY_EXP,@COPY,@COPY,2000,'$2,000',0,@START_DATE,@END_DATE);
SET @TRAVEL_DOCS = (SELECT benefitId FROM ctm.travel_benefit_master WHERE benefitName='TRAVEL_DOCS');
...
INSERT INTO ctm.travel_product_benefits (id,providerId,productId,benefitId,label,description,benefitValue,benefitValueText,overrideExternal,startDate,endDate) VALUES 
	...
	(null,44,@FOW_DOME,@TRAVEL_DOCS,@COPY,@COPY,0,'Nil',0,@START_DATE,@END_DATE),
	(null,44,@FOW_ESSE,@TRAVEL_DOCS,@COPY,@COPY,2500,'$2,500',0,@START_DATE,@END_DATE),
	(null,44,@FOW_COMP,@TRAVEL_DOCS,@COPY,@COPY,5000,'$5,000',0,@START_DATE,@END_DATE),
	(null,44,@FOW_LAST,@TRAVEL_DOCS,@COPY,@COPY,0,'Nil',0,@START_DATE,@END_DATE),
	(null,44,@FOW_AMT,@TRAVEL_DOCS,@COPY,@COPY,5000,'$5,000',0,@START_DATE,@END_DATE);