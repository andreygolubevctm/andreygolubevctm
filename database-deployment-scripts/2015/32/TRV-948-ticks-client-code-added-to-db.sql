...
-- UPDATE `ctm`.`service_properties` SET `servicePropertyValue`='SPName=au.com.Compare,clientID=507' WHERE providerid=323 AND servicePropertyKey = 'outBoundParams' AND servicePropertyValue = 'SPName=au.com.Compare,clientID=507';
