...
INSERT INTO `features_product_type` VALUES (1,'Comprehensive','COMP','CAR'),(2,'Third Party Fire & Theft','TPFT','CAR'),(3,'Third Party Property','TPP','CAR'),(4,'Home','HOME','HOME'),(5,'Contents','CONT','HOME'),(6,'Home & Contents','H&C','HOME');
