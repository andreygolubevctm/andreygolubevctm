...
INSERT INTO aggregator.features_brands (`id`, `displayName`, `realName`, `status`) VALUES
	...
	(5007, '1st For Women', '1st For Women', 'Y'),
	(5008, 'AAMI', 'AAMI', 'Y'),
	(5009, 'AI Insurance', 'AI Insurance', 'Y'),
	(5010, 'Allianz', 'Allianz', 'Y'),
	(5011, 'ANZ', 'ANZ', 'Y'),
	(5012, 'APIA', 'APIA', 'Y'),
	(5013, 'Australia Post', 'Australia Post', 'Y'),
	(5014, 'Australian Seniors Insurance Agency', 'Australian Seniors Insurance Agency', 'Y'),
	(5015, 'Bingle', 'Bingle.com Pty Ltd', 'Y'),
	(5016, 'Budget Direct', 'Budget Direct', 'Y'),
	(5017, 'Cashback', 'Cashback', 'Y'),
	(5018, 'CGU Insurance ', 'CGU Insurance Ltd', 'Y'),
	(5019, 'Coles Insurance', 'Coles Insurance', 'Y'),
	(5020, 'CommInsure', 'CommInsure', 'Y'),
	(5021, 'Dodo Insurance Pty Ltd', 'Dodo Insurance Pty Ltd', 'Y'),
	(5022, 'GIO', 'GIO General Limited', 'Y'),
	(5023, 'ibuyeco', 'ibuyeco', 'Y'),
	(5024, 'Just Car Insurance', 'Just Car Insurance', 'Y'),
	(5025, 'NRMA Insurance', 'NRMA Insurance', 'Y'),
	(5026, 'Ozicare', 'Ozicare', 'Y'),
	(5027, 'Progressive Direct', 'Progressive Direct', 'Y'),
	(5028, 'QBE Insurance', 'QBE Insurance Australia Ltd', 'Y'),
	(5029, 'RAA', 'RAA', 'Y'),
	(5030, 'RACQ', 'RACQI', 'Y'),
	(5031, 'RACT', 'RACT Insurance Pty Ltd', 'Y'),
	(5032, 'RACV', 'RACV', 'Y'),
	(5033, 'RACWA', 'RACWA', 'Y'),
	(5034, 'Real Insurance', 'Real Insurance', 'Y'),
	(5035, 'Resilium', 'Resilium', 'Y'),
	(5036, 'Retirease', 'Retirease', 'Y'),
	(5037, 'SGIC', 'SGIC', 'Y'),
	(5038, 'SGIO', 'SGIO', 'Y'),
	(5039, 'Shannons', 'Shannons', 'Y'),
	(5040, 'Suncorp', 'Suncorp Metway Insurance Limited', 'Y'),
	(5041, 'Vero', 'Vero (Australia)', 'Y'),
	(5042, 'Virgin Money', 'Virgin Money', 'Y'),
	(5043, 'Westpac', 'Westpac (Australia)', 'Y'),
	(5044, 'Woolworths Insurance', 'Woolworths Insurance', 'Y'),
	(5045, 'Youi Insurance', 'Youi Insurance', 'Y');
