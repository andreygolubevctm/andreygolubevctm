...
-- SELECT count(*) FROM `ctm`.`car_product_content` WHERE carProductId IN (SELECT carProductId FROM `ctm`.`car_product` WHERE providerId = @pid) AND effectiveStart = '2011-03-01' AND effectiveEnd = '2040-12-31';
