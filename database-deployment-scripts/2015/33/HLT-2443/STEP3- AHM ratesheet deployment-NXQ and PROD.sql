...
UNION ALL
	...
	AND pm.LongTitle = 'Budget Hospital';
LIMIT 9999;*/
...
/* TEST: if the data may have conflicts, should be 0, otherwise insert update statements are required */
...
/* Test import has worked there should be 28 products
