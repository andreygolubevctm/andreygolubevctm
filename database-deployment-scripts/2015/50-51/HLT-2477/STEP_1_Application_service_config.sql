...
INSERT INTO service_properties (serviceMasterId, environmentCode, styleCodeId, providerId, servicePropertyKey, servicePropertyValue, effectiveStart, effectiveEnd, scope) VALUES
  ...
  (@HEALTH_APP_BASE_MASTER_ID, '0'  , 0, @PROVIDERID, 'serviceName', @SERVICE_NAME, @STARTDATE, @ENDDATE, 'SERVICE'),
  (@HEALTH_APP_BASE_MASTER_ID, '0'  , 0, @PROVIDERID, 'user', 'CompareTM', @STARTDATE, @ENDDATE, 'SERVICE'),
  (@HEALTH_APP_BASE_MASTER_ID, '0'  , 0, @PROVIDERID, 'password', 'Compare', @STARTDATE, @ENDDATE, 'SERVICE'),
  (@HEALTH_APP_BASE_MASTER_ID, 'PRO'  , 0, @PROVIDERID, 'user', 'CompareTM', @STARTDATE, @ENDDATE, 'SERVICE'),
  (@HEALTH_APP_BASE_MASTER_ID, 'PRO'  , 0, @PROVIDERID, 'password', 'Compare456', @STARTDATE, @ENDDATE, 'SERVICE'),
