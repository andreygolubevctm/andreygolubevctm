...
--
-- ROLL BACK
-- UPDATE ctm.service_properties SET servicePropertyValue = 'pricingapi.agaassistance.com.au/api/QuickQuote' WHERE providerId = @pCode AND serviceMasterId = @serviceMasterId AND environmentCode = '0' AND servicePropertyKey = 'url' LIMIT 1;*/
