...
INSERT INTO ctm.product_master (ProductCat,ProductCode,ProviderId, ShortTitle, LongTitle,EffectiveStart,EffectiveEnd,Status) VALUES('CREDITCARD','ANZ-P',48,'ANZ Platinum','ANZ Platinum','2015-08-18','2040-12-31','');
SET @product_id = LAST_INSERT_ID();
DELETE FROM ctm.product_properties WHERE productid = @product_id;
DELETE FROM ctm.product_properties_text WHERE productid = @product_id;
INSERT INTO ctm.product_properties VALUES(@product_id,'rewards-standard-card-points',0,NULL,'',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'card-class',0,0,'Visa',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'extended-warranty',0,1,'Yes',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'cash-advance-rate',0,21.49,'21.49%',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'rewards-bonus-points',0,NULL,'',NULL,'2015-08-18','2040-12-31','',0);
...
-Rental Excess Cover','2015-08-18','2040-12-31','');
INSERT INTO ctm.product_properties VALUES(@product_id,'intro-rate',0,NULL,'',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'maximum-credit-limit',0,0.0,'0',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'rewards-amex-card-points',0,NULL,'',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'balance-transfer-fee',0,2.0,'2%',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'minimum-income',0,50000.0,'$50000',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'intro-annual-fee-period',0,12.0,'12',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'intro-balance-transfer-rate',0,0.0,'0%',NULL,'2015-08-18','2040-12-31','',0);
...
$0 Annual Fee for the first year. Offer ends 20th August 2015.',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties_text VALUES(@product_id,'rewards-desc',0,'','2015-08-18','2040-12-31','');
INSERT INTO ctm.product_properties VALUES(@product_id,'annual-fee',0,87.0,'$87',NULL,'2015-08-18','2040-12-31','',0);
DELETE FROM ctm.category_product_mapping WHERE productId = @product_id;
...
INSERT INTO ctm.product_properties VALUES(@product_id,'minimum-credit-limit',0,6000.0,'$6000',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'slug',0,0,'anz-platinum',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'intro-rate-period',0,NULL,'',NULL,'2015-08-18','2040-12-31','',0);
...
$0 Annual Fee for the first year. Offer ends 20th August 2015.',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'interest-free-days',0,55.0,'55',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'product-type',0,0,'Low annual fee',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'foreign-exchange-fees',0,1,'Yes',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'complimentary-travel-insurance',0,1,'Yes',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'interest-rate',0,19.74,'19.74%',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'intro-annual-fee',0,0.0,'$0',NULL,'2015-08-18','2040-12-31','',0);
...
(subject to a minimum of $25).',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'late-payment-fee',0,20.0,'$20',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'available-temporary-residents',0,1,'Yes',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'handover-url',0,0,'http://prf.hn/click/camref:1101lIt/creativeref:1100l4',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'additional-card-holder',0,1,'Yes',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'balance-transfer-rate',0,19.74,'19.74%',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'intro-balance-transfer-rate-period',0,16.0,'16',NULL,'2015-08-18','2040-12-31','',0);
...
INSERT INTO ctm.product_master (ProductCat,ProductCode,ProviderId, ShortTitle, LongTitle,EffectiveStart,EffectiveEnd,Status) VALUES('CREDITCARD','ANZ-F',48,'ANZ First','ANZ First','2015-08-18','2040-12-31','');
SET @product_id = LAST_INSERT_ID();
DELETE FROM ctm.product_properties WHERE productid = @product_id;
DELETE FROM ctm.product_properties_text WHERE productid = @product_id;
INSERT INTO ctm.product_properties VALUES(@product_id,'rewards-standard-card-points',0,NULL,'',NULL,'2015-08-18','2040-12-31','',0);
...
-Worldwide emergency credit card replacement','2015-08-18','2040-12-31','');
INSERT INTO ctm.product_properties VALUES(@product_id,'intro-rate',0,NULL,'',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'maximum-credit-limit',0,0.0,'0',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'rewards-amex-card-points',0,NULL,'',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'balance-transfer-fee',0,2.0,'2%',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'minimum-income',0,15000.0,'$15000',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'intro-annual-fee-period',0,NULL,'',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'intro-balance-transfer-rate',0,0.0,'0%',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'special-offer',0,0,'0% p.a. first 16 months on balance transfers, plus 2% Balance Transfer fee. Offer ends 20th August 2015.',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties_text VALUES(@product_id,'rewards-desc',0,'','2015-08-18','2040-12-31','');
INSERT INTO ctm.product_properties VALUES(@product_id,'annual-fee',0,30.0,'$30',NULL,'2015-08-18','2040-12-31','',0);
DELETE FROM ctm.category_product_mapping WHERE productId = @product_id;
...
INSERT INTO ctm.product_properties VALUES(@product_id,'minimum-credit-limit',0,1000.0,'$1000',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'slug',0,0,'anz-first',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'intro-rate-period',0,NULL,'',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'product-desc',0,0,'0% p.a. first 16 months on balance transfers, plus 2% Balance Transfer fee. Offer ends 20th August 2015.',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'interest-free-days',0,44.0,'44',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'product-type',0,0,'Low annual fee',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'foreign-exchange-fees',0,1,'Yes',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'complimentary-travel-insurance',0,0,'No',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'interest-rate',0,19.74,'19.74%',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'intro-annual-fee',0,NULL,'',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'minimum-monthly-repayment',0,2.0,'The Minimum Monthly Payment  required from you is generally 2% of the relevant Closing Balance
(subject to a minimum of $25).',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'late-payment-fee',0,20.0,'$20',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'available-temporary-residents',0,1,'Yes',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'handover-url',0,0,'http://prf.hn/click/camref:1101lIt/creativeref:1011l13',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'additional-card-holder',0,1,'Yes',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'balance-transfer-rate',0,19.74,'19.74%',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'intro-balance-transfer-rate-period',0,16.0,'16',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties_text VALUES(@product_id,'terms-general',0,'*Offer for new & approved applications on selected cards. Transfers from non-ANZ cards only.  Apply by 20th August 2015. T&Cs, fees and charges apply.  After the first 16 months any remaining balance transfer will revert to the standard balance transfer annual percentage rate. Subject to credit approval.','2015-08-18','2040-12-31','');
...
INSERT INTO ctm.product_master (ProductCat,ProductCode,ProviderId, ShortTitle, LongTitle,EffectiveStart,EffectiveEnd,Status) VALUES('CREDITCARD','ANZ-LR',48,'ANZ Low Rate','ANZ Low Rate','2015-08-18','2040-12-31','');
SET @product_id = LAST_INSERT_ID();
DELETE FROM ctm.product_properties WHERE productid = @product_id;
DELETE FROM ctm.product_properties_text WHERE productid = @product_id;
INSERT INTO ctm.product_properties VALUES(@product_id,'rewards-standard-card-points',0,NULL,'',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'card-class',0,0,'MasterCard',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'extended-warranty',0,0,'No',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'cash-advance-rate',0,21.74,'21.74%',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'rewards-bonus-points',0,NULL,'',NULL,'2015-08-18','2040-12-31','',0);
...
-MasterCard offers and promotions','2015-08-18','2040-12-31','');
INSERT INTO ctm.product_properties VALUES(@product_id,'intro-rate',0,NULL,'',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'maximum-credit-limit',0,0.0,'0',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'rewards-amex-card-points',0,NULL,'',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'balance-transfer-fee',0,2.0,'2%',NULL,'2015-08-18','2040-12-31','',0);
...
INSERT INTO ctm.product_properties VALUES(@product_id,'special-offer',0,0,'0% p.a. first 16 months on balance transfers, plus 2% Balance Transfer fee. Offer ends 20th August 2015.',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties_text VALUES(@product_id,'rewards-desc',0,'','2015-08-18','2040-12-31','');
INSERT INTO ctm.product_properties VALUES(@product_id,'annual-fee',0,58.0,'$58',NULL,'2015-08-18','2040-12-31','',0);
DELETE FROM ctm.category_product_mapping WHERE productId = @product_id;
...
INSERT INTO ctm.product_properties VALUES(@product_id,'minimum-credit-limit',0,1000.0,'$1000',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'slug',0,0,'anz-low-rate',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'intro-rate-period',0,NULL,'',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'product-desc',0,0,'0% p.a. first 16 months on balance transfers, plus 2% Balance Transfer fee. Offer ends 20th August 2015.',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'interest-free-days',0,55.0,'55',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'product-type',0,0,'Low interest rate',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'foreign-exchange-fees',0,1,'Yes',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'complimentary-travel-insurance',0,0,'No',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'interest-rate',0,13.49,'13.49% p.a',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'intro-annual-fee',0,NULL,'',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'minimum-monthly-repayment',0,2.0,'The Minimum Monthly Payment  required from you is generally 2% of the relevant Closing Balance
(subject to a minimum of $25).',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'late-payment-fee',0,20.0,'$20',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'available-temporary-residents',0,1,'Yes',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'handover-url',0,0,'http://prf.hn/click/camref:1101lIt/creativeref:1100l5',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'additional-card-holder',0,1,'Yes',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'balance-transfer-rate',0,13.49,'13.49%',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'intro-balance-transfer-rate-period',0,16.0,'16',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties_text VALUES(@product_id,'terms-general',0,'*Offer for new & approved applications on selected cards. Transfers from non-ANZ cards only.  Apply by 20th August 2015. T&Cs, fees and charges apply.  After the first 16 months any remaining balance transfer will revert to the standard balance transfer annual percentage rate. Subject to credit approval.','2015-08-18','2040-12-31','');


INSERT INTO ctm.product_master (ProductCat,ProductCode,ProviderId, ShortTitle, LongTitle,EffectiveStart,EffectiveEnd,Status) VALUES('CREDITCARD','ANZ-LRP',48,'ANZ Low Rate Platinum','ANZ Low Rate Platinum','2015-08-18','2040-12-31','');
SET @product_id = LAST_INSERT_ID();
DELETE FROM ctm.product_properties WHERE productid = @product_id;
DELETE FROM ctm.product_properties_text WHERE productid = @product_id;
INSERT INTO ctm.product_properties VALUES(@product_id,'rewards-standard-card-points',0,NULL,'',NULL,'2015-08-18','2040-12-31','',0);
...
-MasterCard Platinum Privileges','2015-08-18','2040-12-31','');
INSERT INTO ctm.product_properties VALUES(@product_id,'intro-rate',0,NULL,'',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'maximum-credit-limit',0,0.0,'0',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'rewards-amex-card-points',0,NULL,'',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'balance-transfer-fee',0,2.0,'2%',NULL,'2015-08-18','2040-12-31','',0);
...
INSERT INTO ctm.product_properties VALUES(@product_id,'special-offer',0,0,'0% p.a. first 16 months on balance transfers, plus 2% Balance Transfer fee. Offer ends 20th August 2015.',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties_text VALUES(@product_id,'rewards-desc',0,'','2015-08-18','2040-12-31','');
INSERT INTO ctm.product_properties VALUES(@product_id,'annual-fee',0,99.0,'$99',NULL,'2015-08-18','2040-12-31','',0);
DELETE FROM ctm.category_product_mapping WHERE productId = @product_id;
...
INSERT INTO ctm.product_properties VALUES(@product_id,'minimum-credit-limit',0,6000.0,'$6000',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'slug',0,0,'anz-low-rate-platinum',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'intro-rate-period',0,NULL,'',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'product-desc',0,0,'0% p.a. first 16 months on balance transfers, plus 2% Balance Transfer fee. Offer ends 20th August 2015.',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'interest-free-days',0,55.0,'55',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'product-type',0,0,'Low interest rate with Platinum benefits',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'foreign-exchange-fees',0,1,'Yes',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'complimentary-travel-insurance',0,1,'Yes',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'interest-rate',0,13.49,'13.49% p.a',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'intro-annual-fee',0,NULL,'',NULL,'2015-08-18','2040-12-31','',0);
...
INSERT INTO ctm.product_properties VALUES(@product_id,'late-payment-fee',0,20.0,'$20',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'available-temporary-residents',0,1,'Yes',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'handover-url',0,0,'http://prf.hn/click/camref:1101lIt/creativeref:1100l3',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'additional-card-holder',0,1,'Yes',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'balance-transfer-rate',0,13.49,'13.49%',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties VALUES(@product_id,'intro-balance-transfer-rate-period',0,16.0,'16',NULL,'2015-08-18','2040-12-31','',0);
INSERT INTO ctm.product_properties_text VALUES(@product_id,'terms-general',0,'*Offer for new & approved applications on selected cards. Transfers from non-ANZ cards only.  Apply by 20th August 2015. T&Cs, fees and charges apply.  After the first 16 months any remaining balance transfer will revert to the standard balance transfer annual percentage rate. Subject to credit approval.','2015-08-18','2040-12-31','');
