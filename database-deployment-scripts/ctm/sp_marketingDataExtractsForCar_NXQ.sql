...
DECLARE $url VARCHAR(256) DEFAULT "https://nxq.secure.comparethemarket.com.au/ctm/"; -- NOTE: needs to be upgraded per environment but is useful for stopping rogue lists
