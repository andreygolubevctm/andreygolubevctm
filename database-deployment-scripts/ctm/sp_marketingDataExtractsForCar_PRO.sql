...
DECLARE $url VARCHAR(256) DEFAULT "https://secure.comparethemarket.com.au/ctm/"; -- NOTE: needs to be upgraded per environment but is useful for stopping rogue lists
