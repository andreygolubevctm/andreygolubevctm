...
-- Update
UPDATE ctm.product_master SET EffectiveEnd='2016-01-14', Status='X' WHERE ProviderId=@pId AND ProductCat='CREDITCARD' AND productCode IN ('BNKW-BLR','BNKW-BLRG','BNKW-BLRP');

-- Check - 3 products with effective end date of 2016-01-14 and Status of 'X'
SELECT * FROM ctm.product_master WHERE ProviderId=@pId AND ProductCat='CREDITCARD' AND productCode IN ('BNKW-BLR','BNKW-BLRG','BNKW-BLRP');
