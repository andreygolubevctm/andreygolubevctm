...
INSERT INTO ctm.configuration (configCode,environmentCode,styleCodeId,verticalId,configValue) 
	VALUES ('splitTest_optins_count','0','1','4','3') ON DUPLICATE KEY UPDATE configValue=VALUES(configValue);
INSERT INTO ctm.configuration (configCode,environmentCode,styleCodeId,verticalId,configValue) 
	VALUES ('splitTest_optins_1_jVal','0','1','4','1') ON DUPLICATE KEY UPDATE configValue=VALUES(configValue);
INSERT INTO ctm.configuration (configCode,environmentCode,styleCodeId,verticalId,configValue) 
	VALUES ('splitTest_optins_1_range','0','1','4','0') ON DUPLICATE KEY UPDATE configValue=VALUES(configValue);
INSERT INTO ctm.configuration (configCode,environmentCode,styleCodeId,verticalId,configValue) 
...
INSERT INTO ctm.configuration (configCode,environmentCode,styleCodeId,verticalId,configValue) 
	VALUES ('splitTest_optins_3_range','0','1','4','100') ON DUPLICATE KEY UPDATE configValue=VALUES(configValue);
