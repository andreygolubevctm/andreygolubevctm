...
INSERT INTO ctm.service_master (verticalId, serviceCode) VALUES (@HEALTH_VERTICAL_ID, 'healthApplyService');
SET @SERVICE_MASTER_ID = (SELECT serviceMasterId FROM ctm.service_master WHERE verticalId=@HEALTH_VERTICAL_ID AND serviceCode='healthApplyService');
...
--
-- DELETE FROM ctm.service_master WHERE verticalId=@HEALTH_VERTICAL_ID AND serviceCode='healthApplyService';