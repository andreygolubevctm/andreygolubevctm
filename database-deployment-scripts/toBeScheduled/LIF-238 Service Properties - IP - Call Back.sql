...
INSERT INTO `ctm`.`service_master` (`verticalId`, `serviceCode`) VALUES ('8', 'getACallLeadFeedService');
SET @CALLBACK_LEAD_FEED_MASTER_ID = (SELECT `serviceMasterId` FROM `ctm`.`service_master` WHERE `verticalId` = '8' AND `serviceCode` = 'getACallLeadFeedService');
...
VALUES
  ...
  (@CALLBACK_LEAD_FEED_MASTER_ID, '0', 1, 63, "messageText", "CTM - IP Vertical - Callback Lead", "2015-07-07 00:00:00", "2040-12-12 11:59:59", "SERVICE"),
