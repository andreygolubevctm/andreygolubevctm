...
test( "should get is post box", function() {
...
test( "should get url for single digit", 1, function() {
...
test( "should get url for single digit and start of street", 1, function() {
	var expectedUrlPrefix = "ajax/html/smart_street.jsp?&postCode=&fieldId=test_streetSearch&showUnable=yes";
	var expectedHouseNumber = "1";
	var streetSearch = $("#test_streetSearch");
	init_address("test");
...
test( "should get url for number and street", 1, function() {
	var expectedUrlPrefix = "ajax/html/smart_street.jsp?&postCode=&fieldId=test_streetSearch&showUnable=yes";
	var expectedHouseNumber = "1";
	var streetSearch = $("#test_streetSearch");
	init_address("test");
